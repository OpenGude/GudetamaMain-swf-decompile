package com.hurlant.crypto.symmetric
{
   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         var _loc8_:uint = 0;
         var _loc10_:uint = 0;
         _loc8_ = (_loc8_ = (_loc8_ = (_loc8_ = (param2[param3 + 0] & 255) << 24) | (param2[param3 + 1] & 255) << 16) | (param2[param3 + 2] & 255) << 8) | param2[param3 + 3] & 255;
         _loc7_ = (_loc7_ = (_loc7_ = (_loc7_ = (param2[param3 + 4] & 255) << 24) | (param2[param3 + 5] & 255) << 16) | (param2[param3 + 6] & 255) << 8) | param2[param3 + 7] & 255;
         _loc6_ = (_loc8_ >>> 4 ^ _loc7_) & 252645135;
         _loc7_ ^= _loc6_;
         _loc6_ = ((_loc8_ ^= _loc6_ << 4) >>> 16 ^ _loc7_) & 65535;
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 16;
         _loc6_ = (_loc7_ >>> 2 ^ _loc8_) & 858993459;
         _loc8_ ^= _loc6_;
         _loc6_ = ((_loc7_ ^= _loc6_ << 2) >>> 8 ^ _loc8_) & 16711935;
         _loc8_ ^= _loc6_;
         _loc7_ = ((_loc7_ ^= _loc6_ << 8) << 1 | _loc7_ >>> 31 & 1) & 4294967295;
         ...
         while(_loc9_ < 8)
         {
            _loc6_ = (_loc6_ = _loc7_ << 28 | _loc7_ >>> 4) ^ param1[_loc9_ * 4 + 0];
            _loc10_ = (_loc10_ = (_loc10_ = (_loc10_ = SP7[_loc6_ & 63]) | SP5[_loc6_ >>> 8 & 63]) | SP3[_loc6_ >>> 16 & 63]) | SP1[_loc6_ >>> 24 & 63];
            _loc6_ = _loc7_ ^ param1[_loc9_ * 4 + 1];
            _loc10_ = (_loc10_ = (_loc10_ = (_loc10_ |= SP8[_loc6_ & 63]) | SP6[_loc6_ >>> 8 & 63]) | SP4[_loc6_ >>> 16 & 63]) | SP2[_loc6_ >>> 24 & 63];
            _loc6_ = (_loc6_ = (_loc8_ ^= _loc10_) << 28 | _loc8_ >>> 4) ^ param1[_loc9_ * 4 + 2];
            _loc10_ = (_loc10_ = (_loc10_ = (_loc10_ = SP7[_loc6_ & 63]) | SP5[_loc6_ >>> 8 & 63]) | SP3[_loc6_ >>> 16 & 63]) | SP1[_loc6_ >>> 24 & 63];
         ...
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_;
         _loc6_ = ((_loc8_ = _loc8_ << 31 | _loc8_ >>> 1) >>> 8 ^ _loc7_) & 16711935;
         _loc7_ ^= _loc6_;
         _loc6_ = ((_loc8_ ^= _loc6_ << 8) >>> 2 ^ _loc7_) & 858993459;
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 2;
         _loc6_ = (_loc7_ >>> 16 ^ _loc8_) & 65535;
         _loc8_ ^= _loc6_;
         _loc6_ = ((_loc7_ ^= _loc6_ << 16) >>> 4 ^ _loc8_) & 252645135;
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_ << 4;
