      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         while(_loc41_ < _loc19_ && _error == "")
         {
            ...
            else
            {
               ...
               {
                  _loc29_ = _loc29_.slice(_loc29_.search(_loc15_.name#2) + _loc15_.name#2.length);
                  ...
                  if(!(_loc42_ = _loc29_.match(/vc\[([vof][acostdip]?)(\d*)?(\.[xyzw](\+\d{1,3})?)?\](\.[xyzw]{1,4})?|([vof][acostdip]?)(\d*)?(\.[xyzw]{1,4})?/gi)) || _loc42_.length != _loc15_.numRegister)
                  {
                  ...
                  while(_loc43_ < _loc49_)
                  {
                     ...
                     if(!(_loc16_ = _loc42_[_loc43_].match(/^\b[A-Za-z]{1,2}/gi)))
                     {
                     ...
                     _loc42_[_loc43_] = _loc42_[_loc43_].slice(_loc42_[_loc43_].search(_loc18_.name#2) + _loc18_.name#2.length);
