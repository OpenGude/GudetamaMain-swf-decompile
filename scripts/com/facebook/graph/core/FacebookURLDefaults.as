package com.facebook.graph.core
{
   public class FacebookURLDefaults
   {
      ...
      public static var LOGIN_SUCCESS_URL:String = "https://www.facebook.com/connect/login_success.html";
      
      public static var LOGIN_SUCCESS_SECUREURL:String = "https://www.facebook.com/connect/login_success.html";
      
      public static var LOGIN_FAIL_URL:String = "https://www.facebook.com/connect/login_success.html?error_reason";
