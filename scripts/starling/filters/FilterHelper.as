package starling.filters
{
   ...
   class FilterHelper implements IFilterHelper
   {
      ...
      function FilterHelper(param1:String = "bgra")
      {
         ...
         super();
         var _loc2_:* = Starling;
         _usePotTextures = starling.core.Starling.sCurrent.profile == "baselineConstrained";
         var _loc3_:* = Starling;
         _preferredScale = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.contentScaleFactor : 1;
      ...
      private function setSize(param1:Number, param2:Number) : void
      {
         ...
         var _loc4_:int = (_loc9_ = !!(_loc10_ = starling.core.Starling.current) ? _loc10_.profile : "baseline") == "baseline" || _loc9_ == "baselineConstrained" ? 2048 : 4096;
      ...
      {
         var _loc2_:*;
         _preferredScale = param1 > 0 ? param1 : (_loc2_ = Starling, Number(!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.contentScaleFactor : 1));
      }
