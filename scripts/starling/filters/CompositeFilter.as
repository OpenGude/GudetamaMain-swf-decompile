...
class CompositeEffect extends FilterEffect
{
   ...
   function CompositeEffect(param1:int = 4)
   {
      var _loc2_:int = 0;
      super();
   ...
   override protected function createProgram() : Program
   {
      ...
      var _loc2_:* = null;
      var _loc4_:Array;
      var _loc1_:int = (_loc4_ = getUsedLayers(sLayers)).length;
      if(_loc1_)
      {
   ...
   override protected function beforeDraw(param1:Context3D) : void
   {
      ...
      var _loc4_:Array;
      var _loc2_:int = (_loc4_ = getUsedLayers(sLayers)).length;
      if(_loc2_)
      {
         _loc5_ = 0;
         while(_loc5_ < _loc2_)
         {
            ...
            _loc7_ = !!_loc6_.replaceColor ? 1 : Number(_loc6_.alpha);
