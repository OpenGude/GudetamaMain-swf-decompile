package starling.filters
{
   ...
   public class FragmentFilter extends EventDispatcher
   {
      ...
      public function FragmentFilter()
      {
         ...
         var _loc1_:* = Starling;
         starling.core.Starling.sCurrent.stage3D.addEventListener("context3DCreate",onContextCreated,false,0,true);
      }
      
      public function dispose() : void
      {
         var _loc1_:* = Starling;
         starling.core.Starling.sCurrent.stage3D.removeEventListener("context3DCreate",onContextCreated);
         if(_helper)
         {
            _helper.dispose();
         }
      ...
      private function renderPasses(param1:Painter, param2:Boolean) : void
      {
         ...
         var _loc8_:Stage = starling.core.Starling.sCurrent.stage;
         ...
         if(_target == starling.core.Starling.sCurrent.root)
         {
         ...
         RectangleUtil.extendToWholePixels(_loc11_,!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.contentScaleFactor : 1);
         var _loc16_:* = Starling;
         _helper.textureScale = (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.contentScaleFactor : 1) * _resolution;
