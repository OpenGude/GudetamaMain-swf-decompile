   ...
   public class AssetManager extends EventDispatcher
   {
      ...
      public function loadQueue(param1:Function) : void
      {
         ...
         var processXml:* = function(param1:int):void
         {
            ...
            var _loc4_:XML;
            var _loc6_:String = (_loc4_ = xmls[param1]).localName();
         ...
         var _loc2_:* = Starling;
         _starling = starling.core.Starling.sCurrent;
                  ...
                  if(asset is Bitmap)
                  {
                     ...
                     texture.root.onRestore = function():void
                     {
                        ...
                        loadRawAsset(rawAsset,null,function(param1:Object):void
                        {
                           ...
                           var _loc4_:* = Starling;
                           starling.core.Starling.sCurrent.stage.setRequiresRedraw();
      ...
      protected function loadRawAsset(param1:Object, param2:Function, param3:Function) : void
      {
         ...
         var onUrlLoaderComplete:* = function(param1:Object):void
         {
            ...
            var _loc3_:* = null;
            var _loc4_:* = null;
            var _loc2_:ByteArray = transformData(urlLoader.data#2 as ByteArray,url);
            if(_loc2_ == null)
            {
               complete(null);
               return;
      ...
      protected function getName(param1:Object) : String
      {
         ...
         {
            _loc2_ = (param1 as URLRequest).url#2;
         }
         else if(param1 is FileReference)
         {
            _loc2_ = (param1 as FileReference).name#2;
         }
         if(_loc2_)
         {
