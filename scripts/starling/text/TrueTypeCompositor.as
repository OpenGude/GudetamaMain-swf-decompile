package starling.text
{
   ...
   public class TrueTypeCompositor implements ITextCompositor
   {
      ...
      private function renderText(param1:Number, param2:Number, param3:String, param4:starling.text.TextFormat, param5:TextOptions) : BitmapDataEx
      {
         ...
         {
            sNativeTextField.text#2 = param3;
         }
         if(param5.autoScale)
         {
         ...
         var _loc17_:* = Texture;
         var _loc18_:String;
         var _loc19_:Starling;
         var _loc8_:int = (_loc18_ = !!(_loc19_ = starling.core.Starling.current) ? _loc19_.profile : "baseline") == "baseline" || _loc18_ == "baselineConstrained" ? 2048 : 4096;
         var _loc11_:int = 1;
         var _loc12_:* = 0;
         if(param5.isHtmlText)
         {
         ...
         {
            param5.textureScale *= _loc8_ / Math.max(_loc13_,_loc14_);
