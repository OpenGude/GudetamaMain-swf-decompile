package starling.text
{
   ...
   public class TextField extends DisplayObjectContainer
   {
      ...
      protected var _requiresRecomposition:Boolean;
      
      private var _border:DisplayObjectContainer;
      
      protected var _meshBatch:MeshBatch;
      ...
      public static function registerCompositor(param1:ITextCompositor, param2:String) : void
      {
         ...
         var _loc3_:Dictionary = starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] as flash.utils.Dictionary;
         if(_loc3_ == null)
         {
            _loc3_ = new flash.utils.Dictionary();
            starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] = _loc3_;
         }
         _loc3_[convertToLowerCase(param2)] = param1;
      }
      
      public static function unregisterCompositor(param1:String, param2:Boolean = true) : void
      {
         param1 = convertToLowerCase(param1);
         if(param2 && _loc3_[param1] != undefined)
         {
            var _loc4_:Dictionary;
            if((_loc4_ = starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] as flash.utils.Dictionary) == null)
            {
               _loc4_ = new flash.utils.Dictionary();
               starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] = _loc4_;
            }
            _loc4_[param1].dispose();
         }
         var _loc5_:Dictionary;
         if((_loc5_ = starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] as flash.utils.Dictionary) == null)
         {
            _loc5_ = new flash.utils.Dictionary();
            starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] = _loc5_;
         }
      ...
      {
         var _loc2_:Dictionary = starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] as flash.utils.Dictionary;
         if(_loc2_ == null)
         {
            _loc2_ = new flash.utils.Dictionary();
            starling.core.Starling.painter.sharedData["starling.display.TextField.compositors"] = _loc2_;
         }
         return _loc2_[convertToLowerCase(param1)];
      }
      ...
      {
         var _loc2_:* = Starling;
         var _loc1_:Dictionary = (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._painter : null).sharedData["starling.display.TextField.compositors"] as Dictionary;
         if(_loc1_ == null)
         {
            _loc1_ = new Dictionary();
            var _loc3_:* = Starling;
            (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._painter : null).sharedData["starling.display.TextField.compositors"] = _loc1_;
         }
         return _loc1_;
      }
      ...
      private function updateText() : void
      {
         ...
         var _loc5_:* = Starling;
         _options.textureScale = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.contentScaleFactor : 1;
      ...
      {
         _meshBatch.style = _style = param1;
         setRequiresRecomposition();
      }
   }
}
