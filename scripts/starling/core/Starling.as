package starling.core
{
   ...
   public class Starling extends EventDispatcher
   {
      ...
      public var _frameTimestamp:Number;
      
      private var _frameID:uint;
      
      private var _leftMouseDown:Boolean;
      
      public var _statsDisplay:StatsDisplay;
      ...
      public function Starling(param1:Class, param2:flash.display.Stage, param3:Rectangle = null, param4:Stage3D = null, param5:String = "auto", param6:Object = "auto")
      {
         ...
         var _loc12_:* = SystemUtil;
         starling.utils.SystemUtil.initialize();
         var _loc7_:int;
         if((_loc7_ = parseInt(starling.utils.SystemUtil.sVersion.split(",").shift())) < 19)
         {
            var _loc13_:* = SystemUtil;
            starling.utils.SystemUtil.initialize();
            _loc8_ = !!starling.utils.SystemUtil.sAIR ? "Adobe AIR" : "Flash Player";
      ...
      public function render() : void
      {
         ...
         makeCurrent();
         updateViewPort();
         var _loc3_:Boolean = _stage.requiresRedraw || mustAlwaysRender;
         if(_loc3_)
         {
            dispatchEventWith("render");
            _loc4_ = _painter.shareContext;
      ...
      private function onStage3DError(param1:ErrorEvent) : void
      {
         ...
         {
            stopWithFatalError("Stage3D error: " + param1.text#2);
         }
      }
      ...
      {
         var _loc1_:Array = [];
         if(flash.ui.Multitouch.inputMode == "touchPoint")
         {
            _loc1_.push("touchBegin","touchMove","touchEnd");
         }
         if(flash.ui.Multitouch.inputMode != "touchPoint" || Mouse.supportsCursor)
         {
      ...
      private function get mustAlwaysRender() : Boolean
      {
         ...
         var _loc3_:* = SystemUtil;
         starling.utils.SystemUtil.initialize();
         if(starling.utils.SystemUtil.sDesktop && profile != "baselineConstrained")
         {
            return false;
         }
