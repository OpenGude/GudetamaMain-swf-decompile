package starling.core
{
   ...
   class StatsDisplay extends Sprite
   {
      ...
      function StatsDisplay()
      {
         ...
         _loc2_ = 100;
         super();
         var _loc6_:Number = !!supportsGpuMem ? 55 : 27;
         var _loc5_:String = !!supportsGpuMem ? "\ngpu memory:" : "";
         var _loc7_:String = "frames/sec:\nstd memory:" + _loc5_ + "\ndraw calls:";
         _labels = new TextField(100,_loc6_,_loc7_);
         _labels.format.setTo("mini",8,16777215,"left");
         _labels.batchable = true;
         _labels.x = 2;
         _values = new TextField(100 - 1,_loc6_,"");
         _values.format.setTo("mini",10,16777215,"right");
         _values.batchable = true;
         _background = new Quad(100,_loc6_,0);
      ...
      public function update() : void
      {
         ...
         var _loc5_:*;
         _gpuMemory = !!supportsGpuMem ? (_loc5_ = Starling, (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null)["totalGPUMemory"] * 9.5367431640625e-7) : -1;
      ...
      {
         var _loc1_:* = Starling;
         return "totalGPUMemory" in (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null);
      }
