   ...
   public class Polygon
   {
      ...
      public function triangulate(param1:IndexData = null, param2:int = 0) : IndexData
      {
         ...
         while(_loc13_ > 3)
         {
            ...
            var _loc19_:* = _loc5_.y;
            var _loc17_:* = _loc5_.x;
            var _loc20_:* = _loc4_.y;
            var _loc18_:* = _loc4_.x;
            var _loc22_:* = _loc3_.y;
            var _loc21_:* = _loc3_.x;
            if((_loc22_ - _loc20_) * (_loc17_ - _loc18_) + (_loc18_ - _loc21_) * (_loc19_ - _loc20_) >= 0)
            {
               _loc6_ = true;
               _loc11_ = 3;
      ...
      public function get isConvex() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            var _loc5_:* = _coords[(_loc2_ + 5) % _loc1_];
            var _loc3_:* = _coords[(_loc2_ + 4) % _loc1_];
            var _loc6_:* = _coords[(_loc2_ + 3) % _loc1_];
            var _loc4_:* = _coords[(_loc2_ + 2) % _loc1_];
            var _loc8_:* = _coords[_loc2_ + 1];
            var _loc7_:* = _coords[_loc2_];
            if((_loc8_ - _loc6_) * (_loc3_ - _loc4_) + (_loc4_ - _loc7_) * (_loc5_ - _loc6_) < 0)
            {
               return false;
            }
            _loc2_ += 2;
