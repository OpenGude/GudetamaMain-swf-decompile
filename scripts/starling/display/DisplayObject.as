package starling.display
{
   ...
   public class DisplayObject extends EventDispatcher
   {
      ...
      private var _followPosition:Boolean;
      ...
      var _transformationParent:DisplayObject;
      
      var _transformationTargetSpace:DisplayObject;
      ...
      private static function findCommonParent(param1:DisplayObject, param2:DisplayObject) : DisplayObject
      {
         ...
         while(_loc5_)
         {
            sAncestors[sAncestors.length] = _loc5_;
            _loc5_ = _loc5_._parent;
         }
         _loc5_ = param2;
         while(_loc5_ && sAncestors.indexOf(_loc5_) == -1)
         {
            _loc5_ = _loc5_._parent;
         }
         sAncestors.length = 0;
         ...
         _loc4_ = new ArgumentError("Object not connected to target");
         _loc3_ = getDefinitionByName("gudetama.engine.Engine") as Class;
         if(_loc3_)
         {
            _loc3_.traceLog(_loc4_);
         }
         else
         {
      ...
      public function getTransformationMatrix(param1:DisplayObject, param2:Matrix = null) : Matrix
      {
         ...
         {
            _loc4_ = this;
            while(_loc4_ && _loc4_ != param1)
            {
               param2.concat(_loc4_.transformationMatrix);
               if(_loc4_._transformationParent && _loc4_._transformationParent.root)
               {
                  param2.concat(_loc4_._transformationParent.getTransformationMatrix(_loc4_._transformationTargetSpace,sHelperMatrix));
               }
         ...
         _loc4_ = this;
         while(_loc4_ && _loc4_ != _loc3_)
         {
            _loc4_.setOrientationChanged();
            param2.concat(_loc4_.transformationMatrix);
            if(_loc4_._transformationParent && _loc4_._transformationParent.root)
            {
               param2.concat(_loc4_._transformationParent.getTransformationMatrix(_loc4_._transformationTargetSpace,sHelperMatrix));
      ...
      public function getTargetSpacePoint(param1:DisplayObject, param2:Point = null) : Point
      {
         if(param2 == null)
         {
            param2 = new Point();
         ...
         MatrixUtil.transformCoords(sHelperMatrix,pivotX * scaleX,pivotY * scaleY,sHelperPoint);
         param2.setTo(sHelperPoint.x,sHelperPoint.y);
         return param2;
      }
      
      public function setTransformationParent(param1:DisplayObject, param2:DisplayObject = null) : void
      {
         _transformationParent = param1;
         _transformationTargetSpace = !!param2 ? param2 : stage;
      }
      ...
      public function drawToBitmapData(param1:BitmapData = null) : BitmapData
      {
         ...
         {
            _loc11_ = (_loc10_ = getBounds(_parent,sHelperRect)).x;
            _loc12_ = _loc10_.y;
            if(!param1)
            {
      ...
      public function setRequiresRedraw() : void
      {
         ...
         var _loc3_:* = Starling;
         var _loc2_:int = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._frameID : 0;
      ...
      {
         var _loc2_:* = Starling;
         var _loc1_:uint = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._frameID : 0;
      ...
      {
         var _loc1_:* = Starling;
         starling.core.Starling.sCurrent.stage.addEnterFrameListener(this);
      }
      
      private function removeEnterFrameListenerFromStage() : void
      {
         var _loc1_:* = Starling;
         starling.core.Starling.sCurrent.stage.removeEnterFrameListener(this);
      }
      ...
      public function get followPosition() : Boolean
      {
         return _followPosition;
      }
      
      public function set followPosition(param1:Boolean) : void
      {
         _followPosition = param1;
      }
      ...
      public function set mask(param1:DisplayObject) : void
      {
         if(_mask != param1)
         {
            ...
            {
               var _loc2_:* = SystemUtil;
               if(!starling.utils.SystemUtil.sSupportsDepthAndStencil)
               {
