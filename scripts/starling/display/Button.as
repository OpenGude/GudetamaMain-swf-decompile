package starling.display
{
   ...
   public class Button extends DisplayObjectContainer
   {
      ...
      protected var _alphaWhenDisabled:Number;
      ...
      protected function setStateTexture(param1:Texture) : void
      {
      ...
      {
         return !!_textField ? _textField.text#2 : "";
      }
