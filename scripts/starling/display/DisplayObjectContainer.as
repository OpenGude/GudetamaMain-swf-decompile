package starling.display
{
   ...
   public class DisplayObjectContainer extends DisplayObject
   {
      ...
      public function getChildByName(param1:String) : DisplayObject
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(_children[_loc3_].name#2 == param1)
            {
      ...
      public function visibleAllChildren(param1:Boolean) : void
      {
         var _loc3_:int = 0;
         var _loc2_:int = _children.length;
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
         {
            _children[_loc3_].visible = param1;
            _loc3_++;
         }
      }
      
      public function disableAllEventDispatcherChildren() : void
      {
         var _loc2_:int = 0;
         ...
         while(_loc2_ < _loc1_)
         {
            _children[_loc2_].disableDispatchEvent();
            if(_children[_loc2_] as DisplayObjectContainer)
            {
               _children[_loc2_].disableAllEventDispatcherChildren();
            }
            _loc2_++;
         }
      }
      
      public function enableAllEventDispatcherChildren() : void
      {
         var _loc2_:int = 0;
         var _loc1_:int = _children.length;
         _loc2_ = 0;
         while(_loc2_ < _loc1_)
         {
            _children[_loc2_].enableDispatchEvent();
            if(_children[_loc2_] as DisplayObjectContainer)
            {
               _children[_loc2_].enableAllEventDispatcherChildren();
            }
            _loc2_++;
         }
      }
         ...
         while(_loc7_ < _loc6_)
         {
            if((_loc10_ = _children[_loc7_])._hasVisibleArea)
            {
               ...
               else
               {
                  ...
                  if(_loc10_._transformationParent && _loc10_._transformationParent.root)
                  {
                     MatrixUtil.prependMatrix(param1.state.modelviewMatrix,_loc10_._transformationParent.getTransformationMatrix(_loc10_._transformationTargetSpace,sHelperMatrix));
                  }
