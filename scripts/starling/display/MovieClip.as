package starling.display
{
   ...
   public class MovieClip extends Image implements IAnimatable
   {
      ...
      private var _textureNames:Object;
      
      private var _textureNamePrefix:String;
      
      public function MovieClip(param1:Vector.<Texture>, param2:Number = 12)
      {
         var _loc3_:Texture = param1.length > 0 ? param1[0] : Texture.empty(10,10);
         super(_loc3_);
         if(param1.length > 0)
         {
            init(param1,param2);
      ...
      public function addFrameAt(param1:int, param2:Texture, param3:Sound = null, param4:Number = -1) : void
      {
         ...
         if(param1 == numFrames)
         {
            _loc6_ = param1 > 0 ? _frames[param1 - 1].startTime : 0;
            _loc5_ = param1 > 0 ? _frames[param1 - 1].duration : 0;
      ...
      public function set textureNames(param1:Object) : void
      {
         var _loc2_:* = undefined;
         var _loc4_:* = null;
         _textureNames = param1;
         var _loc3_:Array = _textureNames as Array;
         if(!MukuGlobal.isBuilderMode() && _loc3_ && _frames == null)
         {
            _loc3_ = _loc3_.concat();
            _loc3_.sort();
            _loc2_ = new Vector.<Texture>();
            for each(var _loc5_ in _loc3_)
            {
               if(_loc4_ = MukuGlobal.assetMediator.getTexture(_loc5_))
               {
      ...
      public function get textureNames() : Object
      {
         return _textureNames;
      }
      
      public function set textureNamePrefix(param1:String) : void
      {
         _textureNamePrefix = param1;
      }
      
      public function get textureNamePrefix() : String
      {
         return _textureNamePrefix;
      }
   }
}
...
class MovieClipFrame
{
   ...
   function MovieClipFrame(param1:Texture, param2:Number = 0.1, param3:Number = 0)
   {
      super();
      this.texture = param1;
