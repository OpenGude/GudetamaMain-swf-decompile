package starling.extensions
{
   public class ColorArgb
   {
      ...
      public function toRgb() : uint
      {
         ...
         return int(_loc1_ * 255) << 16 | int(_loc3_ * 255) << 8 | int(_loc2_ * 255);
      }
      
      public function toArgb() : uint
      {
         var _loc1_:* = Number(alpha);
         if(_loc1_ < 0)
         {
            _loc1_ = 0;
         }
         ...
         return int(_loc1_ * 255) << 24 | int(_loc2_ * 255) << 16 | int(_loc4_ * 255) << 8 | int(_loc3_ * 255);
      }
