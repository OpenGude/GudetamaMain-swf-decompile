package starling.extensions
{
   ...
   public class ColorOffsetStyle extends MeshStyle
   {
      ...
      public function ColorOffsetStyle(param1:Number = 0, param2:Number = 0, param3:Number = 0, param4:Number = 0)
      {
         super();
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:ColorOffsetStyle = param1 as ColorOffsetStyle;
         if(_loc2_)
         {
            _loc3_ = 0;
            while(_loc3_ < 4)
...
class ColorOffsetEffect extends MeshEffect
{
   ...
   override protected function createProgram() : Program
   {
      ...
      if(texture)
      {
         ...
         _loc2_ = [tex("ft0","v0",0,texture) + "mul ft0, ft0, v1",_loc3_].join("\n");
      }
      else
      {
