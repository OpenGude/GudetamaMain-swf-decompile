package starling.rendering
{
   ...
   public class VertexDataFormat
   {
      ...
      {
         return _attributes[param1].name#2;
      }
      ...
      public function hasAttribute(param1:String) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(_attributes[_loc3_].name#2 == param1)
            {
               return true;
            }
            _loc3_++;
      ...
      public function setVertexBufferAt(param1:int, param2:VertexBuffer3D, param3:String) : void
      {
         ...
         var _loc5_:* = Starling;
         (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null).setVertexBufferAt(param1,param2,_loc4_.offset / 4,_loc4_.format);
      }
      ...
      private function parseFormat(param1:String) : void
      {
         ...
         if(param1 != null && param1 != "")
         {
            ...
            while(_loc6_ < _loc4_)
            {
               ...
               _loc3_ += _loc8_.size;
               _format += (_loc6_ == 0 ? "" : ", ") + _loc8_.name#2 + ":" + _loc8_.format;
      ...
      function getAttribute(param1:String) : VertexDataAttribute
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc4_ = _attributes[_loc3_]).name#2 == param1)
            {
               return _loc4_;
            }
            _loc3_++;
