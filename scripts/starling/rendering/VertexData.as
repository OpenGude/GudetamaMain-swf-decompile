package starling.rendering
{
   ...
   public class VertexData
   {
      ...
      public function copyTo(param1:VertexData, param2:int = 0, param3:Matrix = null, param4:int = 0, param5:int = -1) : void
      {
         ...
         else
         {
            ...
            while(_loc7_ < _numAttributes)
            {
               ...
               var _loc17_:* = _loc10_.name#2;
               var _loc14_:* = param1;
               var _loc15_:int = 0;
               while(true)
               {
                  if(_loc15_ >= _loc14_._numAttributes)
                  {
                     §§push(null);
                     break;
                  }
                  var _loc16_:VertexDataAttribute;
                  if((_loc16_ = _loc14_._attributes[_loc15_]).name#2 == _loc17_)
                  {
                     §§push(_loc16_);
                     break;
                  }
      ...
      public function copyAttributeTo(param1:VertexData, param2:int, param3:String, param4:Matrix = null, param5:int = 0, param6:int = -1) : void
      {
         ...
         while(true)
         {
            if(_loc10_ >= this._numAttributes)
            {
               §§push(null);
               break;
            }
            var _loc11_:VertexDataAttribute;
            if((_loc11_ = this._attributes[_loc10_]).name#2 == _loc12_)
            {
               §§push(_loc11_);
               break;
            }
         ...
         var _loc8_:VertexDataAttribute = §§pop();
         var _loc15_:* = param3;
         var _loc9_:* = param1;
         var _loc13_:int = 0;
         while(true)
         {
            if(_loc13_ >= _loc9_._numAttributes)
            {
               §§push(null);
               break;
            }
            var _loc14_:VertexDataAttribute;
            if((_loc14_ = _loc9_._attributes[_loc13_]).name#2 == _loc15_)
            {
               §§push(_loc14_);
               break;
            }
         ...
         var _loc7_:VertexDataAttribute = §§pop();
         if(_loc8_ == null)
         {
      ...
      public function getUnsignedInt(param1:int, param2:String) : uint
      {
         ...
         var _loc3_:int = 0;
         §§push(_rawData);
         §§push(param1 * _vertexSize);
         while(true)
         {
            if(_loc3_ >= this._numAttributes)
            {
               §§push(null);
               break;
            }
            var _loc4_:VertexDataAttribute;
            if((_loc4_ = this._attributes[_loc3_]).name#2 == _loc5_)
            {
               §§push(_loc4_);
               break;
            }
      ...
      public function setUnsignedInt(param1:int, param2:String, param3:uint) : void
      {
         ...
         while(true)
         {
            if(_loc4_ >= this._numAttributes)
            {
               §§push(null);
               break;
            }
            var _loc5_:VertexDataAttribute;
            if((_loc5_ = this._attributes[_loc4_]).name#2 == _loc6_)
            {
               §§push(_loc5_);
               break;
            }
      ...
      public function getPoint(param1:int, param2:String, param3:Point = null) : Point
      {
         ...
         else
         {
            ...
            while(true)
            {
               if(_loc5_ >= this._numAttributes)
               {
                  §§push(null);
                  break;
               }
               var _loc6_:VertexDataAttribute;
               if((_loc6_ = this._attributes[_loc5_]).name#2 == _loc7_)
               {
                  §§push(_loc6_);
                  break;
               }
      ...
      public function setPoint(param1:int, param2:String, param3:Number, param4:Number) : void
      {
         ...
         else
         {
            ...
            while(true)
            {
               if(_loc6_ >= this._numAttributes)
               {
                  §§push(null);
                  break;
               }
               var _loc7_:VertexDataAttribute;
               if((_loc7_ = this._attributes[_loc6_]).name#2 == _loc8_)
               {
                  §§push(_loc7_);
                  break;
               }
      ...
      public function setPoint4D(param1:int, param2:String, param3:Number, param4:Number, param5:Number, param6:Number = 1.0) : void
      {
         ...
         while(true)
         {
            if(_loc7_ >= this._numAttributes)
            {
               §§push(null);
               break;
            }
            var _loc8_:VertexDataAttribute;
            if((_loc8_ = this._attributes[_loc7_]).name#2 == _loc9_)
            {
               §§push(_loc8_);
               break;
            }
      ...
      public function getColor(param1:int, param2:String = "color") : uint
      {
         ...
         _rawData.position = param1 * _vertexSize + _loc4_;
         var _loc8_:*;
         var _loc3_:uint = ((_loc8_ = _rawData.readUnsignedInt()) & 255) << 24 | (_loc8_ >> 8 & 255) << 16 | (_loc8_ >> 16 & 255) << 8 | _loc8_ >> 24 & 255;
      ...
      public function getBounds(param1:String = "position", param2:Matrix = null, param3:int = 0, param4:int = -1, param5:Rectangle = null) : Rectangle
      {
         ...
         else
         {
            ...
            else
            {
               ...
               while(true)
               {
                  if(_loc15_ >= this._numAttributes)
                  {
                     §§push(null);
                     break;
                  }
                  var _loc16_:VertexDataAttribute;
                  if((_loc16_ = this._attributes[_loc15_]).name#2 == _loc17_)
                  {
                     §§push(_loc16_);
                     break;
                  }
      ...
      public function getBoundsProjected(param1:String, param2:Matrix3D, param3:Vector3D, param4:int = 0, param5:int = -1, param6:Rectangle = null) : Rectangle
      {
         ...
         else
         {
            ...
            else
            {
               ...
               while(true)
               {
                  if(_loc16_ >= this._numAttributes)
                  {
                     §§push(null);
                     break;
                  }
                  var _loc17_:VertexDataAttribute;
                  if((_loc17_ = this._attributes[_loc16_]).name#2 == _loc18_)
                  {
                     §§push(_loc17_);
                     break;
                  }
            ...
            while(_loc6_ < _numAttributes)
            {
               if((_loc8_ = _attributes[_loc6_]).isColor)
               {
                  ...
                  while(_loc7_ < _numVertices)
                  {
                     ...
                     var _loc9_:*;
                     _loc3_ = uint(((_loc9_ = _rawData.readUnsignedInt()) & 255) << 24 | (_loc9_ >> 8 & 255) << 16 | (_loc9_ >> 16 & 255) << 8 | _loc9_ >> 24 & 255);
                     _loc5_ = uint(!!param1 ? premultiplyAlpha(_loc3_) : uint(unmultiplyAlpha(_loc3_)));
                     _rawData.position = _loc4_;
                     var _loc10_:*;
                     _rawData.writeUnsignedInt(((_loc10_ = _loc5_) & 255) << 24 | (_loc10_ >> 8 & 255) << 16 | (_loc10_ >> 16 & 255) << 8 | _loc10_ >> 24 & 255);
                     _loc4_ += _vertexSize;
                     _loc7_++;
                  }
               }
      ...
      public function translatePoints(param1:String, param2:Number, param3:Number, param4:int = 0, param5:int = -1) : void
      {
         ...
         else
         {
            ...
            while(true)
            {
               if(_loc11_ >= this._numAttributes)
               {
                  §§push(null);
                  break;
               }
               var _loc12_:VertexDataAttribute;
               if((_loc12_ = this._attributes[_loc11_]).name#2 == _loc13_)
               {
                  §§push(_loc12_);
                  break;
               }
      ...
      public function scaleAlphas(param1:String, param2:Number, param3:int = 0, param4:int = -1) : void
      {
         ...
         while(_loc9_ < param4)
         {
            ...
            else
            {
               _rawData.position = _loc7_;
               var _loc14_:*;
               _loc5_ = uint((_loc5_ = uint(unmultiplyAlpha(((_loc14_ = _rawData.readUnsignedInt()) & 255) << 24 | (_loc14_ >> 8 & 255) << 16 | (_loc14_ >> 16 & 255) << 8 | _loc14_ >> 24 & 255))) & 4294967040 | int(_loc8_ * 255) & 255);
               _loc5_ = uint(premultiplyAlpha(_loc5_));
               _rawData.position = _loc7_;
               var _loc15_:*;
               _rawData.writeUnsignedInt(((_loc15_ = _loc5_) & 255) << 24 | (_loc15_ >> 8 & 255) << 16 | (_loc15_ >> 16 & 255) << 8 | _loc15_ >> 24 & 255);
            }
            _loc7_ += _vertexSize;
            _loc9_++;
         }
      ...
      public function colorize(param1:String = "color", param2:uint = 16777215, param3:Number = 1.0, param4:int = 0, param5:int = -1) : void
      {
         ...
         var _loc13_:*;
         _rawData.writeUnsignedInt(((_loc13_ = _loc6_) & 255) << 24 | (_loc13_ >> 8 & 255) << 16 | (_loc13_ >> 16 & 255) << 8 | _loc13_ >> 24 & 255);
         while(_loc8_ < _loc9_)
         {
            _rawData.position = _loc8_;
            var _loc14_:*;
            _rawData.writeUnsignedInt(((_loc14_ = _loc6_) & 255) << 24 | (_loc14_ >> 8 & 255) << 16 | (_loc14_ >> 16 & 255) << 8 | _loc14_ >> 24 & 255);
            _loc8_ += _vertexSize;
         }
      }
      ...
      public function getFormat(param1:String) : String
      {
         ...
         while(true)
         {
            if(_loc2_ >= this._numAttributes)
            {
               §§push(null);
               break;
            }
            var _loc3_:VertexDataAttribute = this._attributes[_loc2_];
            if(_loc3_.name#2 == _loc4_)
            {
               §§push(_loc3_);
               break;
            }
      ...
      {
         var _loc5_:* = Starling;
         var _loc3_:Context3D = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null;
         if(_loc3_ == null)
         {
      ...
      public function set format(param1:VertexDataFormat) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            var _loc12_:* = (_loc7_ = param1.attributes[_loc4_]).name#2;
            var _loc10_:int = 0;
            while(true)
            {
               if(_loc10_ >= this._numAttributes)
