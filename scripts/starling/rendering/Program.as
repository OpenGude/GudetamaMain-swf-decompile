package starling.rendering
{
   ...
   public class Program
   {
      ...
      public function Program(param1:ByteArray, param2:ByteArray)
      {
         ...
         var _loc3_:* = Starling;
         starling.core.Starling.sCurrent.stage3D.addEventListener("context3DCreate",onContextCreated,false,30,true);
      }
      ...
      public function activate(param1:Context3D = null) : void
      {
         ...
         {
            var _loc2_:* = Starling;
            param1 = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null;
            if(param1 == null)
            {
