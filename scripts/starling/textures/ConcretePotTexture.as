package starling.textures
{
   ...
   class ConcretePotTexture extends ConcreteTexture
   {
      ...
      {
         var _loc1_:* = Starling;
         return (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null).createTexture(nativeWidth,nativeHeight,format,optimizedForRenderTexture);
      }
