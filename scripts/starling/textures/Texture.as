   ...
   public class Texture
   {
      ...
      public static function fromEmbeddedAsset(param1:Class, param2:Boolean = false, param3:Boolean = false, param4:Number = 1, param5:String = "bgra", param6:Boolean = false) : starling.textures.Texture
      {
         ...
         else
         {
            ...
            texture.root.getBitmap = function(param1:Function):void
            {
               param1(new assetClass().bitmapData,true);
            };
         }
         asset = null;
         return texture;
      ...
      public static function fromAtfData(param1:ByteArray, param2:Number = 1, param3:Boolean = true, param4:Function = null, param5:Boolean = false) : starling.textures.Texture
      {
         ...
         var _loc6_:* = Starling;
         var context:Context3D = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null;
         if(context == null)
         {
      ...
      private static function fromVideoAttachment(param1:String, param2:Object, param3:Number, param4:Function) : starling.textures.Texture
      {
         ...
         if(!flash.display3D.Context3D["supportsVideoTexture"])
         {
      ...
      public static function empty(param1:Number, param2:Number, param3:Boolean = true, param4:Boolean = false, param5:Boolean = false, param6:Number = -1, param7:String = "bgra", param8:Boolean = false) : starling.textures.Texture
      {
         ...
         if(param6 <= 0)
         {
            var _loc17_:* = Starling;
            param6 = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.contentScaleFactor : 1;
         }
         var _loc18_:* = Starling;
         var _loc15_:Context3D;
         if((_loc15_ = !!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent.context : null) == null)
         {
            throw new MissingContextError();
         }
         ...
         var _loc12_:Boolean;
         if(_loc12_ = !param8 && !param4 && starling.core.Starling.sCurrent.profile != "baselineConstrained" && param7.indexOf("compressed") == -1)
         {
      ...
      {
         var _loc3_:* = Starling;
         var _loc2_:Starling = starling.core.Starling.sCurrent;
      ...
      public static function setErrorHandler(param1:Function) : void
      {
         errorHandler = param1;
      }
      ...
      public function getBitmapData(param1:Function) : BitmapData
      {
         return root.getBitmap(param1);
      }
   }
}
