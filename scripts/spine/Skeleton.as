package spine
{
   ...
   public class Skeleton
   {
      ...
      public function updateCache() : void
      {
         ...
         while(_loc6_ < _loc9_)
         {
            ...
            while(true)
            {
               if(_loc1_ < _loc3_)
               {
                  if((_loc10_ = _loc12_[_loc1_]).data#2.order == _loc6_)
                  {
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     ...
                     if((_loc7_ = _loc4_[_loc1_]).data#2.order == _loc6_)
                     {
      ...
      {
         var _loc6_:Slot;
         var _loc9_:Number = (_loc6_ = param1.target).data#2.index;
         var _loc5_:Bone = _loc6_.bone;
         if(skin != null)
         {
            sortPathConstraintAttachment(skin,_loc9_,_loc5_);
         }
         if(data#2.defaultSkin != null && data#2.defaultSkin != skin)
         {
            sortPathConstraintAttachment(data#2.defaultSkin,_loc9_,_loc5_);
         }
         var _loc2_:* = 0;
         var _loc3_:* = 0;
         _loc2_ = 0;
         _loc3_ = Number(data#2.skins.length);
         while(_loc2_ < _loc3_)
         {
            sortPathConstraintAttachment(data#2.skins[_loc2_],_loc9_,_loc5_);
            _loc2_++;
         }
      ...
      public function get data#2() : SkeletonData
      {
         return _data;
      }
      ...
      {
         var _loc2_:Skin = data#2.findSkin(param1);
         if(_loc2_ == null)
         {
      ...
      {
         return getAttachmentForSlotIndex(data#2.findSlotIndex(param1),param2);
      }
      ...
      public function getAttachmentForSlotIndex(param1:int, param2:String) : Attachment
      {
         ...
         if(data#2.defaultSkin != null)
         {
            return data#2.defaultSkin.getAttachment(param1,param2);
         }
         return null;
      }
      ...
      {
         return _data.name#2 != null ? _data.name#2 : super.toString();
      }
   }
}
