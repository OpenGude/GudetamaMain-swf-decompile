   ...
   public class ShearTimeline extends TranslateTimeline
   {
      ...
      override public function apply(param1:Skeleton, param2:Number, param3:Number, param4:Vector.<Event>, param5:Number, param6:Boolean, param7:Boolean) : void
      {
         ...
         if(param3 < _loc8_[0])
         {
            if(param6)
            {
               _loc10_.shearX = _loc10_.data#2.shearX;
               _loc10_.shearY = _loc10_.data#2.shearY;
            }
            return;
         }
         ...
         if(param6)
         {
            _loc10_.shearX = _loc10_.data#2.shearX + _loc12_ * param5;
            _loc10_.shearY = _loc10_.data#2.shearY + _loc13_ * param5;
         }
         else
         {
            _loc10_.shearX += (_loc10_.data#2.shearX + _loc12_ - _loc10_.shearX) * param5;
            _loc10_.shearY += (_loc10_.data#2.shearY + _loc13_ - _loc10_.shearY) * param5;
         }
      }
   }
}
