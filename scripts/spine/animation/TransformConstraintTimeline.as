   ...
   public class TransformConstraintTimeline extends CurveTimeline
   {
      ...
      override public function apply(param1:Skeleton, param2:Number, param3:Number, param4:Vector.<Event>, param5:Number, param6:Boolean, param7:Boolean) : void
      {
         ...
         if(param3 < _loc9_[0])
         {
            if(param6)
            {
               _loc10_ = _loc17_.data#2;
               _loc17_.rotateMix = _loc17_.data#2.rotateMix;
               _loc17_.translateMix = _loc17_.data#2.translateMix;
               _loc17_.scaleMix = _loc17_.data#2.scaleMix;
               _loc17_.shearMix = _loc17_.data#2.shearMix;
            }
            return;
         }
