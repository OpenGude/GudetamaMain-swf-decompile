package spine.animation
{
   ...
   public class AttachmentTimeline implements Timeline
   {
      ...
      public function apply(param1:Skeleton, param2:Number, param3:Number, param4:Vector.<Event>, param5:Number, param6:Boolean, param7:Boolean) : void
      {
         ...
         if(param7 && param6)
         {
            _loc10_ = _loc11_.data#2.attachmentName;
      ...
      public function mult(param1:Skeleton, param2:Number, param3:Number, param4:Vector.<Event>, param5:Number, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
      }
   }
}
