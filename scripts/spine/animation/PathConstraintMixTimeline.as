   ...
   public class PathConstraintMixTimeline extends CurveTimeline
   {
      ...
      override public function apply(param1:Skeleton, param2:Number, param3:Number, param4:Vector.<Event>, param5:Number, param6:Boolean, param7:Boolean) : void
      {
         ...
         if(param3 < frames[0])
         {
            if(param6)
            {
               _loc12_.rotateMix = _loc12_.data#2.rotateMix;
               _loc12_.translateMix = _loc12_.data#2.translateMix;
            }
            return;
         }
         ...
         if(param6)
         {
            _loc12_.rotateMix = _loc12_.data#2.rotateMix + (_loc8_ - _loc12_.data#2.rotateMix) * param5;
            _loc12_.translateMix = _loc12_.data#2.translateMix + (_loc11_ - _loc12_.data#2.translateMix) * param5;
         }
         else
         {
