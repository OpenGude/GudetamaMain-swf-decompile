package spine.animation
{
   ...
   public class AnimationState
   {
      ...
      public var data#2:AnimationStateData;
      
      public var tracks:Vector.<TrackEntry>;
      
      public var manuallyTrack:TrackEntry;
      ...
      private var appliedIds:Dictionary;
      
      public var animeEndCallback:Function;
      ...
      public function apply(param1:Skeleton) : void
      {
         ...
         var _loc17_:Vector.<Event> = this.events;
         _loc4_ = 0;
         _loc6_ = tracks.length;
         while(_loc4_ < _loc6_)
         {
            if(!((_loc7_ = tracks[_loc4_]) == null || _loc7_.delay > 0))
            {
               _loc16_ = Number(_loc7_.alpha);
               if(_loc7_.mixingFrom != null)
               {
                  _loc16_ *= applyMixingFrom(_loc7_,param1);
               }
               else if(_loc7_.trackTime >= _loc7_.trackEnd)
               {
                  _loc16_ = 0;
               }
               _loc13_ = _loc7_.animationLast;
               var _loc2_:Number = _loc7_.getAnimationTime();
               _loc10_ = _loc7_.animation.timelines.length;
               _loc8_ = _loc7_.animation.timelines;
               _loc3_ = 0;
               if(_loc16_ == 1)
               {
                  _loc3_ = 0;
                  ...
                  {
                     Timeline(_loc8_[_loc3_]).apply(param1,_loc13_,_loc2_,_loc17_,1,true,false);
                     setAppliedId(_loc8_[_loc3_].getPropertyId());
                     _loc3_++;
                  }
               }
               else
               {
                  if(_loc9_ = _loc7_.timelinesRotation.length == 0)
                  {
                     _loc7_.timelinesRotation.length = _loc10_ << 1;
                  }
                  _loc15_ = _loc7_.timelinesRotation;
                  _loc11_ = _loc7_.timelinesFirst;
                  _loc3_ = 0;
                  while(_loc3_ < _loc10_)
                  {
                     if((_loc14_ = _loc8_[_loc3_]) is RotateTimeline)
                     {
                        applyRotateTimeline(_loc14_,param1,_loc2_,_loc16_,_loc11_[_loc3_],_loc15_,_loc3_ << 1,_loc9_);
                     }
                     else
                     {
                        _loc14_.apply(param1,_loc13_,_loc2_,_loc17_,_loc16_,_loc11_[_loc3_],false);
                        setAppliedId(_loc14_.getPropertyId());
                     }
                     _loc3_++;
                  }
               }
               queueEvents(_loc7_,_loc2_);
               _loc17_.length = 0;
               _loc7_.nextAnimationLast = _loc2_;
               _loc7_.nextTrackLast = _loc7_.trackTime;
            }
            _loc4_++;
         }
         if(manuallyTrack)
         {
            _loc12_ = manuallyTrack.animation.timelines.length;
            _loc5_ = manuallyTrack.animation.timelines;
            _loc4_ = 0;
            while(_loc4_ < _loc12_)
            {
               Timeline(_loc5_[_loc4_]).mult(param1,0,manuallyTrack.getAnimationTime(),null,1,true,false,isApplied(_loc5_[_loc4_].getPropertyId()));
               _loc4_++;
            }
         }
         queue.drain();
      ...
      private function applyRotateTimeline(param1:Timeline, param2:Skeleton, param3:Number, param4:Number, param5:Boolean, param6:Vector.<Number>, param7:int, param8:Boolean) : void
      {
         ...
         if(param4 == 1)
         {
            ...
            setAppliedId(param1.getPropertyId());
            return;
         }
         ...
         if(param3 < _loc11_[0])
         {
            if(param5)
            {
               _loc14_.rotation = _loc14_.data#2.rotation;
            }
            return;
         }
         if(param3 >= _loc11_[_loc11_.length - 2])
         {
            _loc9_ = _loc14_.data#2.rotation + _loc11_[_loc11_.length + -1];
         }
         else
         {
            ...
            _loc9_ = (_loc9_ = _loc21_ + _loc9_ * _loc17_ + _loc14_.data#2.rotation) - (16384 - (int(16384.499999999996 - _loc9_ / 360))) * 360;
         }
         var _loc23_:Number = !!param5 ? _loc14_.data#2.rotation : Number(_loc14_.rotation);
         var _loc15_:Number;
      ...
      public function setAnimationByName(param1:int, param2:String, param3:Boolean, param4:Function = null) : TrackEntry
      {
         var _loc5_:Animation;
         if((_loc5_ = data#2.skeletonData.findAnimation(param2)) == null)
         {
            throw new ArgumentError("Animation not found: " + param2);
         }
         animeEndCallback = param4;
         return setAnimation(param1,_loc5_,param3);
      }
      ...
      public function setAnimation(param1:int, param2:Animation, param3:Boolean) : TrackEntry
      {
         ...
         if(!param3 && animeEndCallback)
         {
            _loc4_.trackEnd = _loc4_.animationEnd;
         }
      ...
      public function addAnimation(param1:int, param2:Animation, param3:Boolean, param4:Number) : TrackEntry
      {
         ...
         else
         {
            ...
            if(param4 <= 0)
            {
               ...
               {
                  param4 += _loc5_ * (1 + int(_loc7_.trackTime / _loc5_)) - data#2.getMix(_loc7_.animation,param2);
               }
               else
               {
                  param4 = 0;
      ...
      public function setManuallyAnimation(param1:Animation) : TrackEntry
      {
         if(manuallyTrack != null)
         {
            throw new ArgumentError("manuallyTrack exists.");
         }
         var _loc2_:TrackEntry = trackEntry(0,param1,false,null);
         manuallyTrack = _loc2_;
         return _loc2_;
      }
      ...
      public function setManuallyTime(param1:Number) : void
      {
         ...
         param1 *= timeScale;
         manuallyTrack.trackTime = param1;
      }
      
      public function getManuallyTrackTime(param1:Number) : Number
      {
         return manuallyTrack.trackTime / timeScale / param1;
      }
      ...
      private function trackEntry(param1:int, param2:Animation, param3:Boolean, param4:TrackEntry) : TrackEntry
      {
         ...
         _loc5_.mixAlpha = 1;
         _loc5_.mixTime = 0;
         _loc5_.mixDuration = param4 == null ? 0 : Number(data#2.getMix(param4.animation,param2));
         return _loc5_;
      }
      ...
      public function setanimeEndCallback(param1:Function) : void
      {
         animeEndCallback = param1;
      }
      ...
      private function setAppliedId(param1:int) : void
      {
         if(appliedIds[param1])
         {
            return;
         }
         appliedIds[param1] = param1;
      }
      
      private function isApplied(param1:int) : Boolean
      {
         return appliedIds[param1];
      }
   }
}
