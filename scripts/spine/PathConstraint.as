package spine
{
   ...
   public class PathConstraint implements Constraint
   {
      ...
      public function PathConstraint(param1:PathConstraintData, param2:Skeleton)
      {
         ...
         target = param2.findSlot(param1.target.name#2);
      ...
      public function update() : void
      {
         ...
         if(_loc6_ || _loc5_)
         {
            ...
            {
               var _loc39_:Number = (_loc25_ = (_loc27_ = _loc37_[_loc26_]).data#2.length) * _loc27_.a;
      ...
      public function get data#2() : PathConstraintData
      {
         return _data;
      }
