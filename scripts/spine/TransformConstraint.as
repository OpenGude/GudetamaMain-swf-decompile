package spine
{
   public class TransformConstraint implements Constraint
   {
      ...
      public function TransformConstraint(param1:TransformConstraintData, param2:Skeleton)
      {
         ...
         {
            _bones.push(param2.findBone(_loc3_.name#2));
         }
      ...
      public function update() : void
      {
         ...
         var _loc11_:Number = data#2.offsetRotation * _loc4_;
         var _loc3_:Number = data#2.offsetShearY * _loc4_;
         ...
         while(_loc15_ < _loc19_)
         {
            ...
            if(_loc8_ != 0)
            {
               _temp[0] = data#2.offsetX;
               _temp[1] = data#2.offsetY;
            ...
            if(_loc14_ > 0)
            {
               ...
               if(_loc25_ > 0.00001)
               {
                  _loc25_ = (_loc25_ + (_loc27_ - _loc25_ + data#2.offsetScaleX) * _loc14_) / _loc25_;
               }
               _loc16_._a *= _loc25_;
               _loc16_._c *= _loc25_;
               ...
               if(_loc25_ > 0.00001)
               {
                  _loc25_ = (_loc25_ + (_loc27_ - _loc25_ + data#2.offsetScaleY) * _loc14_) / _loc25_;
               }
               _loc16_._b *= _loc25_;
               _loc16_._d *= _loc25_;
               _loc6_ = true;
      ...
      public function get data#2() : TransformConstraintData
      {
         return _data;
      }
