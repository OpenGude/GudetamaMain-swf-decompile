package spine.attachments
{
   ...
   public dynamic class VertexAttachment extends Attachment
   {
      ...
      public function computeWorldVertices2(param1:Slot, param2:int, param3:int, param4:Vector.<Number>, param5:int) : void
      {
         ...
         var _loc26_:Vector.<int>;
         if((_loc26_ = this.bones) == null)
         {
            if(_loc12_.length > 0)
            {
               _loc9_ = _loc12_;
            }
            _loc29_ = (_loc24_ = param1.bone).worldX;
         ...
         if(_loc12_.length == 0)
         {
            ...
            while(_loc28_ < param3)
            {
               _loc14_ = 0;
               _loc17_ = Number(0);
               _loc25_ = (_loc25_ = _loc26_[_loc27_++]) + _loc27_;
               while(_loc27_ < _loc25_)
               {
                  ...
                  _loc14_ += (_loc7_ * _loc24_.a + _loc8_ * _loc24_.b + _loc24_.worldX) * _loc23_;
                  _loc17_ += (_loc7_ * _loc24_.c + _loc8_ * _loc24_.d + _loc24_.worldY) * _loc23_;
                  _loc27_++;
                  _loc16_ += 3;
               }
