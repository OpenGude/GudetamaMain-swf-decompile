package feathers.text
{
   ...
   public final class StageTextField extends EventDispatcher
   {
      ...
      {
         var _loc2_:* = this;
         if((!!_loc2_._textFormat.italic ? "italic" : "normal") == param1)
         {
            return;
         }
      ...
      {
         var _loc2_:* = this;
         if((!!_loc2_._textFormat.bold ? "bold" : "normal") == param1)
         {
            return;
         }
      ...
      {
         return this._textField.text#2;
      }
      
      public function set text#2(param1:String) : void
      {
         this._textField.text#2 = param1;
      }
      ...
      public function dispose() : void
      {
         var _loc2_:* = null;
         var _loc1_:* = this;
         if(_loc1_._textField.stage != _loc2_)
         {
            if(_loc1_._textField.stage)
            {
               _loc1_._textField.parent.removeChild(_loc1_._textField);
            }
            if(_loc2_)
            {
               _loc2_.addChild(_loc1_._textField);
               _loc1_.dispatchCompleteIfPossible();
            }
         }
      ...
      private function initialize(param1:Object) : void
      {
         ...
         this._textField.addEventListener("keyFocusChange",textField_keyFocusChangeHandler);
