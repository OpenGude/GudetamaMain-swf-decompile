   ...
   public class ProgressBar extends FeathersControl
   {
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc8_)
         {
            ...
            {
               _loc13_ = IFeathersControl(this.currentFill).minWidth;
            }
         ...
         if(_loc12_)
         {
            if(_loc5_ !== null)
            {
               _loc9_ = Number(_loc5_.minHeight);
            }
            else if(this.currentBackground !== null)
            {
               _loc9_ = Number(this._explicitBackgroundMinHeight);
            }
            else
            {
               _loc9_ = 0;
            ...
            if(this.currentFill is IFeathersControl)
            {
               _loc6_ = IFeathersControl(this.currentFill).minHeight;
            }
         ...
         if(_loc3_)
         {
            ...
            {
               _loc1_ = Number(this.currentBackground.width);
            }
            else
            {
               _loc1_ = 0;
         ...
         if(_loc11_)
         {
            if(this.currentBackground !== null)
            {
               _loc4_ = Number(this.currentBackground.height);
            }
            else
            {
               _loc4_ = 0;
      ...
      protected function layoutChildren() : void
      {
         ...
         {
            _loc1_ = Number((this._value - this._minimum) / (this._maximum - this._minimum));
            if(_loc1_ < 0)
            {
               _loc1_ = 0;
            }
