package feathers.controls
{
   ...
   public class SimpleScrollBar extends FeathersControl implements IDirectionalScrollBar
   {
      ...
      protected function layout() : void
      {
         ...
         var _loc13_:* = Number(this._page);
         if(this._page == 0)
         {
            _loc13_ = Number(this._step);
         }
         ...
         if(this._direction == "vertical")
         {
            ...
            if(this.thumb is IMeasureDisplayObject)
            {
               _loc1_ = IMeasureDisplayObject(this.thumb).minHeight;
            }
            _loc2_ = Number(_loc11_ * _loc13_ / _loc5_);
            if((_loc8_ = Number(_loc11_ - _loc2_)) > _loc2_)
            {
               _loc8_ = _loc2_;
            }
            ...
            if((_loc4_ = Number((_loc9_ = _loc11_ - this.thumb.height) * (this._value - this._minimum) / _loc5_)) > _loc9_)
            {
               _loc4_ = _loc9_;
            }
            else if(_loc4_ < 0)
         ...
         else
         {
            ...
            if(this.thumb is IMeasureDisplayObject)
            {
               _loc6_ = IMeasureDisplayObject(this.thumb).minWidth;
            }
            _loc7_ = Number(_loc14_ * _loc13_ / _loc5_);
            if((_loc12_ = Number(_loc14_ - _loc7_)) > _loc7_)
            {
               _loc12_ = _loc7_;
            }
            ...
            _loc3_ = Number((_loc10_ = _loc14_ - this.thumb.width) * (this._value - this._minimum) / _loc5_);
            if(_loc3_ > _loc10_)
            {
               _loc3_ = _loc10_;
            }
      ...
      protected function locationToValue(param1:Point) : Number
      {
         ...
         if(this._direction == "vertical")
         {
            if((_loc7_ = this.actualHeight - this.thumb.height - this._paddingTop - this._paddingBottom) > 0)
            {
               ...
               _loc5_ = Number((_loc6_ = Math.min(Math.max(0,this._thumbStartY + _loc3_),_loc7_)) / _loc7_);
            }
         }
      ...
      protected function track_touchHandler(param1:TouchEvent) : void
      {
         ...
         else
         {
            ...
            this._touchPointID = _loc2_.id#2;
