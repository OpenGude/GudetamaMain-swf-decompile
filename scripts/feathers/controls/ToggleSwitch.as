   ...
   public class ToggleSwitch extends FeathersControl implements IToggle, IFocusDisplayObject, ITextBaselineControl, IStateContext
   {
      ...
      public function ToggleSwitch()
      {
         ...
         if(this._onLabelFontStylesSet === null)
         {
            ...
            this._onLabelFontStylesSet.addEventListener("change",fontStyles_changeHandler);
         }
         if(this._offLabelFontStylesSet === null)
         {
            this._offLabelFontStylesSet = new FontStylesSet();
            this._offLabelFontStylesSet.addEventListener("change",fontStyles_changeHandler);
         }
      ...
      public function set onLabelFontStyles(param1:TextFormat) : void
      {
         ...
         this._onLabelFontStylesSet.format = param1;
      }
      ...
      public function set onLabelDisabledFontStyles(param1:TextFormat) : void
      {
         ...
         this._onLabelFontStylesSet.disabledFormat = param1;
      }
      ...
      public function set onLabelSelectedFontStyles(param1:TextFormat) : void
      {
         ...
         this._onLabelFontStylesSet.selectedFormat = param1;
      }
      ...
      public function set offLabelFontStyles(param1:TextFormat) : void
      {
         ...
         this._offLabelFontStylesSet.format = param1;
      }
      ...
      public function set offLabelDisabledFontStyles(param1:TextFormat) : void
      {
         ...
         this._offLabelFontStylesSet.disabledFormat = param1;
      }
      ...
      public function set offLabelSelectedFontStyles(param1:TextFormat) : void
      {
         ...
         this._offLabelFontStylesSet.selectedFormat = param1;
      }
      ...
      {
         this._onLabelFontStylesSet.setFormatForState(param1,param2);
      }
      ...
      {
         this._offLabelFontStylesSet.setFormatForState(param1,param2);
      }
      ...
      protected function resetState() : void
      {
         if(this._isEnabled)
         {
            ...
            {
               this.changeState("notSelected");
            }
         }
         else if(this._isSelected)
         {
            this.changeState("selectedAndDisabled");
         }
         else
         {
      ...
      protected function layoutChildren() : void
      {
         ...
         {
            _loc2_ = Number(Math.max(this.onTextRenderer.baseline,this.offTextRenderer.baseline));
         }
      ...
      protected function updateSelection() : void
      {
         ...
         {
            var _loc3_:* = Starling;
            (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._juggler : null).remove(this._toggleTween);
         ...
         if(this._animateSelectionChange)
         {
            ...
            var _loc4_:* = Starling;
            (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._juggler : null).add(this._toggleTween);
         }
         else
         {
            this.thumb.x = _loc1_;
      ...
      protected function thumb_touchHandler(param1:TouchEvent) : void
      {
         ...
         if(this._touchPointID >= 0)
         {
            ...
            else if(_loc5_.phase == "ended")
            {
               ...
               if((_loc6_ = _loc3_ / DeviceCapabilities.dpi) > 0.04 || starling.utils.SystemUtil.sDesktop && _loc3_ >= 1)
               {
                  this._touchPointID = -1;
         ...
         else
         {
            ...
            _loc5_.getLocation(this,HELPER_POINT);
            this._touchPointID = _loc5_.id#2;
