   ...
   public class ScrollContainer extends Scroller implements IScrollContainer, IFocusContainer
   {
      ...
      public function set autoSizeMode(param1:String) : void
      {
         ...
         if(this.stage !== null)
         {
            ...
            {
               this.stage.addEventListener("resize",scrollContainer_stage_resizeHandler);
            }
            else
            {
               this.stage.removeEventListener("resize",scrollContainer_stage_resizeHandler);
            }
         }
      ...
      override public function visibleAllChildren(param1:Boolean) : void
      {
         if(!this.displayListBypassEnabled)
         {
            super.visibleAllChildren(param1);
            return;
         }
         DisplayObjectContainer(this.viewPort).visibleAllChildren(param1);
      }
