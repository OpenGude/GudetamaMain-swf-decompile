package feathers.controls
{
   ...
   public class Drawers extends FeathersControl
   {
      ...
      public function get isTopDrawerDocked() : Boolean
      {
         ...
         {
            var _loc2_:* = Starling;
            _loc1_ = starling.core.Starling.sCurrent.stage;
         }
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc2_)
         {
            if(_loc4_)
            {
               if(this._content !== null)
               {
                  _loc1_ = Number(this._originalContentWidth);
               }
               else
               {
                  _loc1_ = 0;
               ...
               {
                  _loc1_ = Number(this._originalTopDrawerWidth);
               }
               if(_loc12_ && this._originalBottomDrawerWidth > _loc1_)
               {
                  _loc1_ = Number(this._originalBottomDrawerWidth);
               }
            }
            else
            {
               _loc1_ = Number(this.stage.stageWidth);
            }
         }
         ...
         if(_loc11_)
         {
            if(_loc4_)
            {
               if(this._content !== null)
               {
                  _loc5_ = Number(this._originalContentHeight);
               }
               else
               {
                  _loc5_ = 0;
               ...
               {
                  _loc5_ = Number(this._originalLeftDrawerHeight);
               }
               if(_loc7_ && this._originalRightDrawerHeight > _loc5_)
               {
                  _loc5_ = Number(this._originalRightDrawerHeight);
               }
            }
            else
            {
               _loc5_ = Number(this.stage.stageHeight);
            }
         }
         ...
         if(_loc9_)
         {
            ...
            {
               _loc8_ = Number(this.stage.stageWidth);
            }
         }
         ...
         if(_loc13_)
         {
            ...
            {
               _loc10_ = Number(this.stage.stageHeight);
            }
         }
      ...
      protected function openOrCloseTopDrawer() : void
      {
         ...
         if(this._openOrCloseTween)
         {
            ...
            var _loc3_:* = Starling;
            (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._juggler : null).remove(this._openOrCloseTween);
         ...
         var _loc2_:Number = !!this._isTopDrawerOpen ? this._topDrawer.height : 0;
         ...
         var _loc4_:* = Starling;
         (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._juggler : null).add(this._openOrCloseTween);
      }
      ...
      protected function openOrCloseRightDrawer() : void
      {
         ...
         if(this._isRightDrawerOpen)
         {
            _loc2_ = Number(-this._rightDrawer.width);
         }
      ...
      protected function openOrCloseBottomDrawer() : void
      {
         ...
         if(this._isBottomDrawerOpen)
         {
            _loc2_ = Number(-this._bottomDrawer.height);
         }
      ...
      protected function openOrCloseLeftDrawer() : void
      {
         ...
         var _loc2_:Number = !!this._isLeftDrawerOpen ? this._leftDrawer.width : 0;
         var _loc1_:Number = this.pendingToggleDuration;
         if(_loc1_ !== _loc1_)
         {
            _loc1_ = this._openOrCloseDuration;
      ...
      protected function handleTouchBegan(param1:Touch) : void
      {
         ...
         if(_loc3_.getClaim(param1.id#2))
         {
            return;
         }
         var _loc11_:*;
         var _loc4_:Starling = this.stage !== null ? this.stage.starling : (_loc11_ = Starling, starling.core.Starling.sCurrent);
         param1.getLocation(this,HELPER_POINT);
         var _loc6_:Number = HELPER_POINT.x;
         ...
         if(!this.isTopDrawerOpen && !this.isRightDrawerOpen && !this.isBottomDrawerOpen && !this.isLeftDrawerOpen)
         {
            ...
            if(this._openGesture === "edge")
            {
               ...
               if(this._topDrawer && !this.isTopDrawerDocked)
               {
                  _loc2_ = _loc5_ / (DeviceCapabilities.dpi / _loc4_.contentScaleFactor);
               ...
               if(!_loc8_)
               {
                  if(this._rightDrawer && !this.isRightDrawerDocked)
                  {
                     if((_loc9_ = (this.actualWidth - _loc6_) / (DeviceCapabilities.dpi / _loc4_.contentScaleFactor)) >= 0 && _loc9_ <= this._openGestureEdgeSize)
                     {
                        _loc8_ = true;
                     }
                  }
                  if(!_loc8_)
                  {
                     if(this._bottomDrawer && !this.isBottomDrawerDocked)
                     {
                        if((_loc10_ = (this.actualHeight - _loc5_) / (DeviceCapabilities.dpi / _loc4_.contentScaleFactor)) >= 0 && _loc10_ <= this._openGestureEdgeSize)
                        {
                           _loc8_ = true;
                        }
                     }
                     if(!_loc8_)
                     {
                        if(this._leftDrawer && !this.isLeftDrawerDocked)
                        {
                           if((_loc7_ = _loc6_ / (DeviceCapabilities.dpi / _loc4_.contentScaleFactor)) >= 0 && _loc7_ <= this._openGestureEdgeSize)
                           {
                              _loc8_ = true;
                           }
                        }
         ...
         this.touchPointID = param1.id#2;
         this._velocityX = 0;
         this._velocityY = 0;
         this._previousVelocityX.length = 0;
         this._previousVelocityY.length = 0;
         this._previousTouchTime = getTimer();
         this._previousTouchX = this._startTouchX = this._currentTouchX = _loc6_;
      ...
      protected function handleDragEnd() : void
      {
         ...
         var _loc7_:Number = NaN;
         var _loc3_:Number = NaN;
         var _loc8_:Number = this._velocityX * 2.33;
         ...
         var _loc10_:*;
         var _loc2_:Starling = this.stage !== null ? this.stage.starling : (_loc10_ = Starling, starling.core.Starling.sCurrent);
         var _loc4_:Number = 1000 * (_loc8_ / _loc5_) / (DeviceCapabilities.dpi / _loc2_.contentScaleFactor);
         _loc8_ = this._velocityY * 2.33;
         _loc1_ = this._previousVelocityY.length;
         _loc5_ = 2.33;
         _loc6_ = 0;
         while(_loc6_ < _loc1_)
         {
         ...
         var _loc9_:Number = 1000 * (_loc8_ / _loc5_) / (DeviceCapabilities.dpi / _loc2_.contentScaleFactor);
         this._isDragging = false;
         if(this._isDraggingTopDrawer)
         {
            this._isDraggingTopDrawer = false;
            if(!this._isTopDrawerOpen && _loc9_ > this._minimumDrawerThrowVelocity)
            {
               this._isTopDrawerOpen = true;
            }
            else if(this._isTopDrawerOpen && _loc9_ < -this._minimumDrawerThrowVelocity)
            {
               this._isTopDrawerOpen = false;
            }
         ...
         {
            this._isDraggingRightDrawer = false;
            if(!this._isRightDrawerOpen && _loc4_ < -this._minimumDrawerThrowVelocity)
            {
               this._isRightDrawerOpen = true;
            }
            else if(this._isRightDrawerOpen && _loc4_ > this._minimumDrawerThrowVelocity)
            {
               this._isRightDrawerOpen = false;
            }
            else if(this._openMode === "above")
            ...
            {
               _loc3_ = this._content.x;
               if(this.isLeftDrawerDocked)
               {
                  _loc3_ -= this._leftDrawer.width;
               }
               this._isRightDrawerOpen = roundToNearest(_loc3_,this._rightDrawer.width) != 0;
            }
            this.openOrCloseRightDrawer();
         }
         ...
         {
            this._isDraggingBottomDrawer = false;
            if(!this._isBottomDrawerOpen && _loc9_ < -this._minimumDrawerThrowVelocity)
            {
               this._isBottomDrawerOpen = true;
            }
            else if(this._isBottomDrawerOpen && _loc9_ > this._minimumDrawerThrowVelocity)
            {
               this._isBottomDrawerOpen = false;
            }
            else if(this._openMode === "above")
            ...
            {
               _loc3_ = this._content.y;
               if(this.isTopDrawerDocked)
               {
                  _loc3_ -= this._topDrawer.height;
               }
               this._isBottomDrawerOpen = roundToNearest(_loc3_,this._bottomDrawer.height) != 0;
            }
            this.openOrCloseBottomDrawer();
         }
         ...
         {
            this._isDraggingLeftDrawer = false;
            if(!this._isLeftDrawerOpen && _loc4_ > this._minimumDrawerThrowVelocity)
            {
               this._isLeftDrawerOpen = true;
            }
            else if(this._isLeftDrawerOpen && _loc4_ < -this._minimumDrawerThrowVelocity)
            {
               this._isLeftDrawerOpen = false;
            }
            else if(this._openMode === "above")
      ...
      protected function handleDragMove() : void
      {
         ...
         if(this._isDraggingLeftDrawer)
         {
            ...
            if(this.isLeftDrawerOpen)
            {
               _loc1_ = Number(_loc3_ + this._currentTouchX - this._startTouchX);
            }
            else
            {
               _loc1_ = Number(this._currentTouchX - this._startTouchX);
            }
            if(_loc1_ < 0)
            {
               _loc1_ = 0;
         ...
         {
            _loc4_ = this._rightDrawer.width;
            if(this.isRightDrawerOpen)
            {
               _loc1_ = Number(-_loc4_ + this._currentTouchX - this._startTouchX);
            }
            else
            {
               _loc1_ = Number(this._currentTouchX - this._startTouchX);
         ...
         else if(this._isDraggingTopDrawer)
         {
            ...
            if(this.isTopDrawerOpen)
            {
               _loc6_ = Number(_loc2_ + this._currentTouchY - this._startTouchY);
            }
            else
            {
               _loc6_ = Number(this._currentTouchY - this._startTouchY);
            }
            if(_loc6_ < 0)
            {
               _loc6_ = 0;
         ...
         {
            _loc5_ = this._bottomDrawer.height;
            if(this.isBottomDrawerOpen)
            {
               _loc6_ = Number(-_loc5_ + this._currentTouchY - this._startTouchY);
            }
            else
            {
               _loc6_ = Number(this._currentTouchY - this._startTouchY);
      ...
      protected function checkForDragToClose() : void
      {
         ...
         var _loc3_:Number = (this._currentTouchX - this._startTouchX) / (DeviceCapabilities.dpi / _loc1_.contentScaleFactor);
         var _loc4_:Number = (this._currentTouchY - this._startTouchY) / (DeviceCapabilities.dpi / _loc1_.contentScaleFactor);
         ...
         else if(this.isTopDrawerOpen && _loc4_ <= -this._minimumDragDistance)
         {
            this._isDragging = true;
            this._isDraggingTopDrawer = true;
            this.prepareTopDrawer();
         }
         else if(this.isBottomDrawerOpen && _loc4_ >= this._minimumDragDistance)
         {
            this._isDragging = true;
      ...
      protected function checkForDragToOpen() : void
      {
         ...
         else if(this._topDrawer && !this.isTopDrawerDocked && _loc4_ >= this._minimumDragDistance)
         {
            this._isDragging = true;
            this._isDraggingTopDrawer = true;
            this.prepareTopDrawer();
         }
         else if(this._bottomDrawer && !this.isBottomDrawerDocked && _loc4_ <= -this._minimumDragDistance)
         {
            this._isDragging = true;
            this._isDraggingBottomDrawer = true;
            this.prepareBottomDrawer();
      ...
      protected function openOrCloseTween_onUpdate() : void
      {
         ...
         if(this._clipDrawers && this._openMode === "below")
         {
            ...
            _loc1_ = this._content.x;
            _loc9_ = this._content.y;
            if(_loc5_)
            {
               if(_loc6_)
               {
      ...
      protected function drawers_addedToStageHandler(param1:Event) : void
      {
         ...
         var _loc4_:*;
         var _loc2_:Starling = this.stage !== null ? this.stage.starling : (_loc4_ = Starling, starling.core.Starling.sCurrent);
         _loc2_.nativeStage.addEventListener("keyDown",drawers_nativeStage_keyDownHandler,false,_loc3_,true);
      }
      ...
      protected function drawers_removedFromStageHandler(param1:Event) : void
      {
         ...
         var _loc4_:*;
         var _loc3_:Starling = this.stage !== null ? this.stage.starling : (_loc4_ = Starling, starling.core.Starling.sCurrent);
         _loc3_.nativeStage.removeEventListener("keyDown",drawers_nativeStage_keyDownHandler);
      }
