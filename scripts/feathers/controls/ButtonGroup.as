package feathers.controls
{
   ...
   public class ButtonGroup extends FeathersControl implements ITextBaselineControl
   {
      ...
      protected function refreshButtons(param1:Boolean) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int;
         var _loc6_:int = (_loc8_ = !!this._dataProvider ? this._dataProvider.length : 0) - 1;
         _loc5_ = 0;
         while(_loc5_ < _loc8_)
         {
      ...
      protected function clearInactiveButtons() : void
      {
         var _loc2_:int = 0;
         var _loc1_:* = null;
         var _loc3_:int = this.inactiveButtons.length;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
      ...
      protected function defaultButtonEventsListener(param1:Event) : void
      {
         ...
         if(_loc3_.hasOwnProperty(_loc4_))
         {
            ...
            switch((int(_loc5_ = _loc6_.length)) - 1)
            {
               case 0:
                  _loc6_(param1);
                  break;
               case 1:
                  _loc6_(param1,param1.data#2);
                  break;
               case 2:
                  _loc6_(param1,param1.data#2,_loc3_);
                  break;
               default:
                  _loc6_();
            }
