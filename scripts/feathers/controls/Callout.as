package feathers.controls
{
   ...
   public class Callout extends FeathersControl
   {
      ...
      protected static const FUZZY_CONTENT_DIMENSIONS_PADDING:Number = 1.0E-6;
      ...
      protected static function positionBelowOrigin(param1:Callout, param2:Rectangle) : void
      {
         ...
         {
            _loc7_ += Math.round((param2.width - param1.width) / 2);
         }
         else if(param1._horizontalAlign === "right")
         {
            _loc7_ += param2.width - param1.width;
         }
         var _loc3_:* = _loc7_;
         if(stagePaddingLeft > _loc3_)
         {
            _loc3_ = Number(stagePaddingLeft);
         }
         else
         {
            var _loc8_:*;
            if((_loc5_ = (_loc4_ = param1.stage !== null ? param1.stage : (_loc8_ = Starling, starling.core.Starling.sCurrent.stage)).stageWidth - param1.width - stagePaddingRight) < _loc3_)
            {
               _loc3_ = _loc5_;
            }
         }
         var _loc6_:Point = Pool.getPoint(_loc3_,param2.y + param2.height);
         param1.parent.globalToLocal(_loc6_,_loc6_);
         param1.x = _loc6_.x;
         param1.y = _loc6_.y;
         Pool.putPoint(_loc6_);
         if(param1._isValidating)
         {
            param1._arrowOffset = _loc7_ - _loc3_;
            param1._arrowPosition = "top";
         }
         else
         {
            param1.arrowOffset = _loc7_ - _loc3_;
      ...
      protected static function positionAboveOrigin(param1:Callout, param2:Rectangle) : void
      {
         ...
         var _loc6_:Point = Pool.getPoint(_loc3_,param2.y - param1.height);
         param1.parent.globalToLocal(_loc6_,_loc6_);
         param1.x = _loc6_.x;
         param1.y = _loc6_.y;
         Pool.putPoint(_loc6_);
      ...
      protected static function positionToRightOfOrigin(param1:Callout, param2:Rectangle) : void
      {
         ...
         {
            _loc6_ += Math.round((param2.height - param1.height) / 2);
         }
         ...
         var _loc5_:* = _loc6_;
         if(stagePaddingTop > _loc5_)
         {
            _loc5_ = Number(stagePaddingTop);
         }
         else
         {
            var _loc8_:*;
            _loc3_ = (_loc4_ = param1.stage !== null ? param1.stage : (_loc8_ = Starling, starling.core.Starling.sCurrent.stage)).stageHeight - param1.height - stagePaddingBottom;
            if(_loc3_ < _loc5_)
            {
               _loc5_ = _loc3_;
            }
         }
         var _loc7_:Point = Pool.getPoint(param2.x + param2.width,_loc5_);
         param1.parent.globalToLocal(_loc7_,_loc7_);
         param1.x = _loc7_.x;
         param1.y = _loc7_.y;
         Pool.putPoint(_loc7_);
         if(param1._isValidating)
         {
            param1._arrowOffset = _loc6_ - _loc5_;
            param1._arrowPosition = "left";
         }
         else
         {
            param1.arrowOffset = _loc6_ - _loc5_;
      ...
      protected static function positionToLeftOfOrigin(param1:Callout, param2:Rectangle) : void
      {
         ...
         var _loc7_:Point = Pool.getPoint(param2.x - param1.width,_loc5_);
         param1.parent.globalToLocal(_loc7_,_loc7_);
         param1.x = _loc7_.x;
         param1.y = _loc7_.y;
         Pool.putPoint(_loc7_);
      ...
      protected function measureWithArrowPosition(param1:String) : Boolean
      {
         ...
         {
            _loc4_ = Number(this._leftArrowSkin.width + this._leftArrowGap);
            _loc21_ = Number(this._leftArrowSkin.height);
         }
         else if(param1 === "right" && this._rightArrowSkin !== null)
         {
            _loc4_ = Number(this._rightArrowSkin.width + this._rightArrowGap);
            _loc21_ = Number(this._rightArrowSkin.height);
         }
         var _loc29_:* = 0;
         var _loc11_:* = 0;
         if(param1 === "top" && this._topArrowSkin !== null)
         {
            _loc29_ = Number(this._topArrowSkin.width);
            _loc11_ = Number(this._topArrowSkin.height + this._topArrowGap);
         }
         else if(param1 === "bottom" && this._bottomArrowSkin !== null)
         {
            _loc29_ = Number(this._bottomArrowSkin.width);
            _loc11_ = Number(this._bottomArrowSkin.height + this._bottomArrowGap);
         }
         ...
         var _loc13_:* = Number(this._explicitMaxWidth);
         ...
         if(_loc15_)
         {
            ...
            if(this._content !== null)
            {
               _loc6_ = Number(this._content.width);
            }
            if(_loc29_ > _loc6_)
            {
               _loc6_ = _loc29_;
            }
            _loc14_ = Number(_loc6_ + this._paddingLeft + this._paddingRight);
            _loc27_ = 0;
            if(this._backgroundSkin !== null)
            {
               _loc27_ = Number(this._backgroundSkin.width);
            }
            if(_loc27_ > _loc14_)
            {
               _loc14_ = _loc27_;
         ...
         if(_loc9_)
         {
            ...
            if(this._content !== null)
            {
               _loc20_ = Number(this._content.height);
            }
            if(_loc21_ > _loc6_)
            {
               _loc20_ = _loc21_;
            }
            _loc3_ = Number(_loc20_ + this._paddingTop + this._paddingBottom);
            _loc25_ = 0;
            if(this._backgroundSkin !== null)
            {
               _loc25_ = Number(this._backgroundSkin.height);
            }
            if(_loc25_ > _loc3_)
            {
               _loc3_ = _loc25_;
         ...
         var _loc23_:* = Number(this._explicitMinWidth);
         if(_loc24_)
         {
            _loc10_ = 0;
            if(_loc2_ !== null)
            {
               _loc10_ = Number(_loc2_.minWidth);
            }
            else if(this._content !== null)
            {
               _loc10_ = Number(this._content.width);
            }
            if(_loc29_ > _loc10_)
            {
               _loc10_ = _loc29_;
            }
            _loc23_ = Number(_loc10_ + this._paddingLeft + this._paddingRight);
            _loc32_ = 0;
            if(_loc17_ !== null)
            {
               _loc32_ = Number(_loc17_.minWidth);
            }
            else if(this._backgroundSkin !== null)
            {
               _loc32_ = Number(this._explicitBackgroundSkinMinWidth);
            }
            if(_loc32_ > _loc23_)
            {
               _loc23_ = _loc32_;
         ...
         var _loc30_:* = Number(this._explicitHeight);
         if(_loc12_)
         {
            _loc26_ = 0;
            if(_loc2_ !== null)
            {
               _loc26_ = Number(_loc2_.minHeight);
            }
            else if(this._content !== null)
            {
               _loc26_ = Number(this._content.height);
            }
            if(_loc21_ > _loc26_)
            {
               _loc26_ = _loc21_;
            }
            _loc30_ = Number(_loc26_ + this._paddingTop + this._paddingBottom);
            _loc19_ = 0;
            if(_loc17_ !== null)
            {
               _loc19_ = Number(_loc17_.minHeight);
            }
            else if(this._backgroundSkin !== null)
            {
               _loc19_ = Number(this._explicitBackgroundSkinMinHeight);
            }
            if(_loc19_ > _loc30_)
            {
               _loc30_ = _loc19_;
      ...
      protected function layoutChildren() : void
      {
         ...
         {
            _loc1_ = Number(this._leftArrowSkin.width + this._leftArrowGap);
         }
         var _loc8_:* = 0;
         if(this._topArrowSkin !== null && this._arrowPosition === "top")
         {
            _loc8_ = Number(this._topArrowSkin.height + this._topArrowGap);
         }
         var _loc12_:* = 0;
         if(this._rightArrowSkin !== null && this._arrowPosition === "right")
         {
            _loc12_ = Number(this._rightArrowSkin.width + this._rightArrowGap);
         }
         var _loc10_:* = 0;
         if(this._bottomArrowSkin !== null && this._arrowPosition === "bottom")
         {
            _loc10_ = Number(this._bottomArrowSkin.height + this._bottomArrowGap);
         }
         ...
         if(this.currentArrowSkin !== null)
         {
            ...
            if(this._arrowPosition === "left")
            {
               ...
               _loc4_ = Number(this._arrowOffset + _loc8_ + this._paddingTop);
            ...
            else if(this._arrowPosition === "right")
            {
               ...
               _loc14_ = Number(this._arrowOffset + _loc8_ + this._paddingTop);
               if(this._verticalAlign === "middle")
               {
            ...
            {
               _loc15_ = Number(this._arrowOffset + _loc1_ + this._paddingLeft);
            ...
            {
               _loc7_ = Number(this._arrowOffset + _loc1_ + this._paddingLeft);
               if(this._horizontalAlign === "center")
               {
      ...
      protected function positionRelativeToOrigin() : void
      {
         ...
         var _loc12_:*;
         var _loc2_:Stage = this.stage !== null ? this.stage : (_loc12_ = Starling, starling.core.Starling.sCurrent.stage);
         var _loc1_:Rectangle = Pool.getRectangle();
         this._origin.getBounds(_loc2_,_loc1_);
         var _loc10_:*;
         if((_loc10_ = this._lastGlobalBoundsOfOrigin != null) && this._lastGlobalBoundsOfOrigin.equals(_loc1_))
         {
         ...
         this._lastGlobalBoundsOfOrigin.x = _loc1_.x;
         this._lastGlobalBoundsOfOrigin.y = _loc1_.y;
         this._lastGlobalBoundsOfOrigin.width = _loc1_.width;
         this._lastGlobalBoundsOfOrigin.height = _loc1_.height;
         Pool.putRectangle(_loc1_);
         var _loc4_:Vector.<String>;
         if((_loc4_ = this._supportedPositions) === null)
         {
         ...
         while(_loc8_ < _loc7_)
         {
            switch(_loc11_ = _loc4_[_loc8_])
            {
               case "top":
                  this.measureWithArrowPosition("bottom");
                  if((_loc5_ = Number(this._lastGlobalBoundsOfOrigin.y - this.actualHeight)) >= stagePaddingTop)
                  {
               ...
               case "right":
                  ...
                  _loc3_ = Number(_loc2_.stageWidth - actualWidth - (this._lastGlobalBoundsOfOrigin.x + this._lastGlobalBoundsOfOrigin.width));
               ...
               case "left":
                  ...
                  if((_loc6_ = Number(this._lastGlobalBoundsOfOrigin.x - this.actualWidth)) >= stagePaddingLeft)
                  {
               ...
               default:
                  ...
                  if((_loc9_ = Number(_loc2_.stageHeight - this.actualHeight - (this._lastGlobalBoundsOfOrigin.y + this._lastGlobalBoundsOfOrigin.height))) >= stagePaddingBottom)
                  {
         ...
         if(_loc9_ !== -1 && _loc9_ >= _loc5_ && _loc9_ >= _loc3_ && _loc9_ >= _loc6_)
         {
            positionBelowOrigin(this,this._lastGlobalBoundsOfOrigin);
         }
         else if(_loc5_ !== -1 && _loc5_ >= _loc3_ && _loc5_ >= _loc6_)
         {
            positionAboveOrigin(this,this._lastGlobalBoundsOfOrigin);
         }
         else if(_loc3_ !== -1 && _loc3_ >= _loc6_)
         {
            positionToRightOfOrigin(this,this._lastGlobalBoundsOfOrigin);
         }
         else
      ...
      protected function callout_addedToStageHandler(param1:Event) : void
      {
         ...
         _loc2_.nativeStage.addEventListener("keyDown",callout_nativeStage_keyDownHandler,false,_loc3_,true);
      ...
      protected function callout_removedFromStageHandler(param1:Event) : void
      {
         ...
         _loc2_.nativeStage.removeEventListener("keyDown",callout_nativeStage_keyDownHandler);
      }
