package feathers.controls.text
{
   ...
   public class TextFieldTextEditorViewPort extends TextFieldTextEditor implements ITextEditorViewPort
   {
      ...
      {
         var _loc5_:* = null;
         var _loc4_:Number = this._visibleWidth - this._paddingLeft - this._paddingRight;
         if(_loc4_ !== _loc4_)
         {
            if(this._maxVisibleWidth < Infinity)
            {
               _loc4_ = this._maxVisibleWidth - this._paddingLeft - this._paddingRight;
            }
            else
            {
               _loc4_ = this._minVisibleWidth - this._paddingLeft - this._paddingRight;
            }
         }
         var _loc6_:Number = this._visibleHeight - this._paddingTop - this._paddingBottom;
         if(_loc6_ !== _loc6_)
         {
            if(this._maxVisibleHeight < Infinity)
            {
               _loc6_ = this._maxVisibleHeight - this._paddingTop - this._paddingBottom;
            }
            else
            {
               _loc6_ = this._minVisibleHeight - this._paddingTop - this._paddingBottom;
            }
         }
         ...
         var _loc8_:*;
         var _loc1_:Starling = this.stage !== null ? this.stage.starling : (_loc8_ = Starling, starling.core.Starling.sCurrent);
         ...
         this._textFieldSnapshotClipRect.height = _loc7_;
      }
      ...
      {
         var _loc12_:*;
         var _loc3_:Starling = this.stage !== null ? this.stage.starling : (_loc12_ = Starling, starling.core.Starling.sCurrent);
         var _loc9_:* = 1;
         if(_loc3_.supportHighResolutions)
         {
            _loc9_ = Number(_loc3_.nativeStage.contentsScaleFactor);
         }
         ...
         MatrixUtil.transformCoords(_loc10_,0,0,_loc11_);
         var _loc1_:Number = matrixToScaleX(_loc10_) * _loc7_;
         var _loc4_:Number = matrixToScaleY(_loc10_) * _loc7_;
         ...
         this.textField.x = _loc2_ + Math.round(_loc6_.x + _loc11_.x * _loc7_ - _loc8_ * _loc1_);
         this.textField.y = _loc5_ + Math.round(_loc6_.y + _loc11_.y * _loc7_ - _loc8_ * _loc4_);
         this.textField.rotation = matrixToRotation(_loc10_) * 180 / 3.141592653589793;
