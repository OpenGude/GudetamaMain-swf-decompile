package feathers.controls
{
   ...
   public class PanelScreen extends Panel implements IScreen
   {
      ...
      protected function panelScreen_addedToStageHandler(param1:Event) : void
      {
         ...
         _loc2_.nativeStage.addEventListener("keyDown",panelScreen_nativeStage_keyDownHandler,false,_loc3_,true);
      }
      ...
      protected function panelScreen_removedFromStageHandler(param1:Event) : void
      {
         ...
         var _loc2_:Starling = stageToStarling(this.stage);
         _loc2_.nativeStage.removeEventListener("keyDown",panelScreen_nativeStage_keyDownHandler);
      }
