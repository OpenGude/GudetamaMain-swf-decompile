package feathers.controls
{
   ...
   public class List extends Scroller implements IFocusContainer
   {
      ...
      protected var _selectedItems:Vector.<Object>;
      ...
      public function List()
      {
         ...
         _selectedItems = new Vector.<Object>(0);
      ...
      public function set selectedIndex(param1:int) : void
      {
         ...
         if(param1 >= 0)
         {
            this._selectedIndices.data#2 = new <int>[param1];
         }
         else
         {
      ...
      {
         return this._selectedIndices.data#2 as Vector.<int>;
      }
      
      public function set selectedIndices(param1:Vector.<int>) : void
      {
         var _loc2_:Vector.<int> = this._selectedIndices.data#2 as Vector.<int>;
         if(_loc2_ == param1)
         {
            return;
         }
         ...
         else
         {
            ...
            this._selectedIndices.data#2 = param1;
         }
         this.invalidate("selected");
      }
      ...
      override protected function handlePendingScroll() : void
      {
         ...
         if(this.pendingItemIndex >= 0)
         {
            ...
            if(_loc1_ is Object)
            {
               ...
               this.dataViewPort.getScrollPositionForIndex(this.pendingItemIndex,_loc3_);
               this.pendingItemIndex = -1;
               _loc2_ = _loc3_.x;
               _loc4_ = _loc3_.y;
               ...
               this.throwTo(_loc2_,_loc4_,this.pendingScrollDuration);
            }
         }
      ...
      protected function dataProvider_addItemHandler(param1:Event, param2:int) : void
      {
         ...
         if(_loc3_)
         {
            this._selectedIndices.data#2 = _loc7_;
         }
      }
      ...
      protected function dataProvider_filterChangeHandler(param1:Event) : void
      {
         ...
         var _loc8_:int = 0;
         var _loc4_:int = this._selectedItems.length;
         _loc5_ = 0;
         while(_loc5_ < _loc4_)
         {
            _loc3_ = this._selectedItems[_loc5_];
            _loc6_ = this._selectedIndices.getItemAt(_loc5_) as int;
            if((_loc7_ = this._dataProvider.getItemIndex(_loc3_)) >= 0)
            {
               if(_loc7_ !== _loc6_)
               {
                  _loc2_ = true;
         ...
         if(_loc2_)
         {
            this._selectedIndices.data#2 = _loc9_;
         }
      }
