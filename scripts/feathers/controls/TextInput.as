   ...
   public class TextInput extends FeathersControl implements ITextBaselineControl, IAdvancedNativeFocusOwner, IStateContext
   {
      ...
      public function TextInput()
      {
         ...
         if(this._promptFontStylesSet === null)
         {
            ...
            this._promptFontStylesSet.addEventListener("change",fontStyles_changeHandler);
         }
      ...
      public function set promptFontStyles(param1:TextFormat) : void
      {
         ...
         this._promptFontStylesSet.format = param1;
      }
      ...
      public function set promptDisabledFontStyles(param1:TextFormat) : void
      {
         ...
         this._promptFontStylesSet.disabledFormat = param1;
      }
      ...
      {
         var _loc3_:String = "setPromptFontStylesForState--" + param1;
         if(this.processStyleRestriction(_loc3_))
         {
            return;
         }
         this._promptFontStylesSet.setFormatForState(param1,param2);
      }
      ...
      public function setSkinForState(param1:String, param2:DisplayObject) : void
      {
         ...
         if(_loc3_ !== null && this.currentBackground === _loc3_)
         {
            this.removeCurrentBackground(_loc3_);
            this.currentBackground = null;
         }
         if(param2 !== null)
         {
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         var _loc16_:* = this._explicitHeight !== this._explicitHeight;
         var _loc14_:* = this._explicitMinWidth !== this._explicitMinWidth;
         var _loc19_:* = this._explicitMinHeight !== this._explicitMinHeight;
         if(!_loc4_ && !_loc16_ && !_loc14_ && !_loc19_)
         {
            return false;
         }
         ...
         if(this._typicalText !== null)
         {
            ...
            _loc10_ = this.textEditor.width;
            _loc1_ = this.textEditor.height;
            _loc11_ = this._ignoreTextChanges;
            this._ignoreTextChanges = true;
            this.textEditor.setSize(NaN,NaN);
            this.textEditor.text = this._typicalText;
            this.textEditor.measureText(_loc7_);
            this.textEditor.text = this._text;
            this._ignoreTextChanges = _loc11_;
            _loc18_ = Number(_loc7_.x);
         ...
         if(this._prompt !== null)
         {
            ...
            this.promptTextRenderer.measureText(_loc7_);
            if(_loc7_.x > _loc18_)
            {
               _loc18_ = Number(_loc7_.x);
            }
         ...
         if(_loc4_)
         {
            ...
            {
               _loc2_ = Number(this.currentBackground.width);
            }
         }
         ...
         if(_loc14_)
         {
            ...
            {
               _loc12_ += IFeathersControl(this.currentIcon).minWidth + this._gap;
            }
            else if(this._originalIconWidth === this._originalIconWidth)
            {
               _loc12_ += this._originalIconWidth + this._gap;
            }
            _loc12_ += this._paddingLeft + this._paddingRight;
            _loc17_ = 0;
            if(_loc6_ !== null)
            {
               _loc17_ = Number(_loc6_.minWidth);
            }
            else if(this.currentBackground !== null)
            {
               _loc17_ = Number(this._explicitBackgroundMinWidth);
            }
            if(_loc17_ > _loc12_)
            {
               _loc12_ = _loc17_;
         ...
         var _loc15_:* = Number(this._explicitMinHeight);
         if(_loc19_)
         {
            _loc15_ = _loc9_;
            if(this.currentIcon is IFeathersControl)
            {
               _loc3_ = IFeathersControl(this.currentIcon).minHeight;
               if(_loc3_ > _loc15_)
               {
                  _loc15_ = _loc3_;
               }
            }
            else if(this._originalIconHeight === this._originalIconHeight && this._originalIconHeight > _loc15_)
            {
               _loc15_ = Number(this._originalIconHeight);
            }
            _loc15_ += this._paddingTop + this._paddingBottom;
            _loc8_ = 0;
            if(_loc6_ !== null)
            {
               _loc8_ = Number(_loc6_.minHeight);
            }
            else if(this.currentBackground !== null)
            {
               _loc8_ = Number(this._explicitBackgroundMinHeight);
            }
            if(_loc8_ > _loc15_)
            {
               _loc15_ = _loc8_;
         ...
         var _loc13_:Boolean = this.textEditor is IMultilineTextEditor && IMultilineTextEditor(this.textEditor).multiline;
         if(this._typicalText !== null && (this._verticalAlign == "justify" || _loc13_))
         {
            this.textEditor.width = _loc10_;
            this.textEditor.height = _loc1_;
         }
         return this.saveMeasurements(_loc2_,_loc5_,_loc12_,_loc15_);
      }
      ...
      protected function setFocusOnTextEditorWithTouch(param1:Touch) : void
      {
         ...
         {
            this.textEditor.globalToLocal(_loc3_,_loc3_);
            this._isWaitingToSetFocus = false;
            this.textEditor.setFocus(_loc3_);
         }
      ...
      protected function textInput_touchHandler(param1:TouchEvent) : void
      {
         ...
         if(this._touchPointID >= 0)
         {
            ...
            _loc2_ = this.contains(this.stage.hitTest(_loc4_));
      ...
      protected function textEditor_changeHandler(param1:Event) : void
      {
         ...
         this.text#2 = this.textEditor.text;
      }
