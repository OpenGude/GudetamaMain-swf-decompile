package feathers.controls
{
   ...
   public class NumericStepper extends FeathersControl implements IRange, IAdvancedNativeFocusOwner, ITextBaselineControl
   {
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         var _loc18_:* = Number(this._explicitMinHeight);
         ...
         if(this._buttonLayoutMode === "rightSideVertical")
         {
            ...
            if(!_loc4_)
            {
               _loc13_ = Number(this._explicitWidth - _loc24_ - this._textInputGap);
            }
            if(!_loc19_)
            {
               _loc1_ = Number(this._explicitHeight);
            }
            if(!_loc14_)
            {
               _loc21_ = Number(this._explicitMinWidth - _loc11_ - this._textInputGap);
               if(this.textInputExplicitMinWidth > _loc21_)
               {
                  _loc21_ = Number(this.textInputExplicitMinWidth);
               }
            }
            if(!_loc22_)
            {
               _loc8_ = Number(this._explicitMinHeight);
               if(this.textInputExplicitMinHeight > _loc8_)
               {
                  _loc8_ = Number(this.textInputExplicitMinHeight);
               }
            }
            _loc17_ = Number(this._explicitMaxWidth - _loc24_ - this._textInputGap);
         }
         else if(this._buttonLayoutMode === "splitVertical")
         {
            if(!_loc4_)
            {
               _loc13_ = Number(this._explicitWidth);
            }
            if(!_loc19_)
            {
               _loc1_ = Number(this._explicitHeight - _loc15_ - _loc10_);
            }
            if(!_loc14_)
            {
               _loc21_ = Number(this._explicitMinWidth);
               if(this.textInputExplicitMinWidth > _loc21_)
               {
                  _loc21_ = Number(this.textInputExplicitMinWidth);
               }
            ...
            if(!_loc22_)
            {
               _loc8_ = Number(this._explicitMinHeight - _loc23_ - _loc7_);
               if(this.textInputExplicitMinHeight > _loc8_)
               {
                  _loc8_ = Number(this.textInputExplicitMinHeight);
               }
            }
            _loc2_ = Number(this._explicitMaxHeight - _loc15_ - _loc10_);
         }
         else
         {
            if(!_loc4_)
            {
               _loc13_ = Number(this._explicitWidth - _loc20_ - _loc5_);
            }
            if(!_loc19_)
            {
               _loc1_ = Number(this._explicitHeight);
            ...
            if(!_loc14_)
            {
               if((_loc21_ = Number(this._explicitMinWidth - _loc9_ - _loc16_)) < this.textInputExplicitMinWidth)
               {
                  _loc21_ = Number(this.textInputExplicitMinWidth);
               }
            }
            ...
            _loc17_ = Number(this._explicitMaxWidth - _loc20_ - _loc5_);
         }
         if(_loc13_ < 0)
         {
            _loc13_ = 0;
         ...
         if(this._buttonLayoutMode === "rightSideVertical")
         {
            if(_loc4_)
            {
               _loc3_ = Number(this.textInput.width + _loc24_ + this._textInputGap);
            }
            if(_loc19_)
            {
               _loc6_ = Number(_loc15_ + this._buttonGap + _loc10_);
               if(this.textInput.height > _loc6_)
               {
                  _loc6_ = Number(this.textInput.height);
               }
            }
            if(_loc14_)
            {
               _loc12_ = Number(this.textInput.minWidth + _loc11_ + this._textInputGap);
            }
            if(_loc22_)
            {
               _loc18_ = Number(_loc23_ + this._buttonGap + _loc7_);
               if(this.textInput.minHeight > _loc18_)
               {
                  _loc18_ = Number(this.textInput.minHeight);
               }
            }
         }
         else if(this._buttonLayoutMode === "splitVertical")
         {
            if(_loc4_)
            {
               _loc3_ = Number(this.textInput.width);
               if(_loc20_ > _loc3_)
               {
                  _loc3_ = _loc20_;
               }
            ...
            if(_loc19_)
            {
               _loc6_ = Number(_loc15_ + this.textInput.height + _loc10_ + 2 * this._textInputGap);
            }
            if(_loc14_)
            {
               _loc12_ = Number(this.textInput.minWidth);
               if(_loc9_ > _loc12_)
               {
                  _loc12_ = _loc9_;
               }
            ...
            if(_loc22_)
            {
               _loc18_ = Number(_loc23_ + this.textInput.minHeight + _loc7_ + 2 * this._textInputGap);
            }
         }
         else
         {
            if(_loc4_)
            {
               _loc3_ = Number(_loc20_ + this.textInput.width + _loc5_ + 2 * this._textInputGap);
            }
            if(_loc19_)
            {
               _loc6_ = Number(this.textInput.height);
            ...
            if(_loc14_)
            {
               _loc12_ = Number(_loc9_ + this.textInput.minWidth + _loc16_ + 2 * this._textInputGap);
            }
            if(_loc22_)
            {
               _loc18_ = Number(this.textInput.minHeight);
      ...
      protected function decrement() : void
      {
         ...
         this.validate();
         this.textInput.selectRange(0,this.textInput.text#2.length);
      }
      ...
      protected function refreshDisplayedText() : void
      {
         ...
         {
            this.textInput.text#2 = this._valueFormatFunction(this._value);
         }
         else
         {
            this.textInput.text#2 = this._value.toString();
         }
      }
      ...
      protected function parseTextInputValue() : void
      {
         ...
         {
            _loc1_ = this._valueParseFunction(this.textInput.text#2);
         }
         else
         {
            _loc1_ = parseFloat(this.textInput.text#2);
         }
         if(_loc1_ === _loc1_)
         {
            this.value = _loc1_;
