   ...
   public class DefaultGroupedListHeaderOrFooterRenderer extends FeathersControl implements IGroupedListHeaderRenderer, IGroupedListFooterRenderer
   {
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc2_ = Number(this.content.width);
            }
            else
            {
               _loc2_ = 0;
         ...
         if(_loc9_)
         {
            ...
            {
               _loc7_ = Number(this.content.height);
            }
            else
            {
               _loc7_ = 0;
            ...
            {
               _loc7_ = Number(this.currentBackgroundSkin.height);
            }
         }
         ...
         if(_loc4_)
         {
            ...
            {
               _loc1_ = Number(_loc6_.minWidth);
            }
            else if(this.content !== null)
            {
               _loc1_ = Number(this.content.width);
            }
            else
            {
               _loc1_ = 0;
            ...
            switch(_loc10_)
            {
               default:
                  ...
                  {
                     _loc1_ = Number(_loc10_.minWidth);
                  }
                  break;
               case null:
         ...
         if(_loc11_)
         {
            ...
            {
               _loc8_ = Number(this.content.height);
            }
            else
            {
               _loc8_ = 0;
            ...
            switch(_loc10_)
            {
               default:
                  ...
                  {
                     _loc8_ = Number(_loc10_.minHeight);
                  }
                  break;
               case null:
      ...
      protected function refreshContentSource(param1:Object) : void
      {
         ...
         this.contentImage.source#2 = param1;
      }
