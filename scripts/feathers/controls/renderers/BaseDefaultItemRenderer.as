package feathers.controls.renderers
{
   ...
   public class BaseDefaultItemRenderer extends ToggleButton implements IFocusContainer
   {
      ...
      protected function itemToIcon(param1:Object) : DisplayObject
      {
         ...
         {
            if((_loc4_ = param1[this._iconLabelField]) is String)
            {
               this.refreshIconLabel(_loc4_ as String);
            }
            else
      ...
      protected function itemToAccessory(param1:Object) : DisplayObject
      {
         ...
         {
            if((_loc4_ = param1[this._accessoryLabelField]) is String)
            {
               this.refreshAccessoryLabel(_loc4_ as String);
            }
            else
      ...
      override protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc4_)
         {
            ...
            {
               _loc3_ = Number(this.addAccessoryWidth(_loc3_));
               _loc3_ = Number(this.addIconWidth(_loc3_));
            }
            else
            {
               _loc3_ = Number(this.addIconWidth(_loc3_));
         ...
         if(_loc9_)
         {
            ...
            if(this._layoutOrder === "labelAccessoryIcon")
            {
               _loc6_ = Number(this.addAccessoryHeight(_loc6_));
               _loc6_ = Number(this.addIconHeight(_loc6_));
            }
            else
            {
               _loc6_ = Number(this.addIconHeight(_loc6_));
            ...
            {
               _loc6_ = Number(this.currentSkin.height);
            }
         }
         ...
         if(_loc5_)
         {
            ...
            if(this._layoutOrder === "labelAccessoryIcon")
            {
               _loc2_ = Number(this.addAccessoryWidth(_loc2_));
               _loc2_ = Number(this.addIconWidth(_loc2_));
            }
            else
            {
               _loc2_ = Number(this.addIconWidth(_loc2_));
            ...
            switch(_loc10_)
            {
               default:
                  ...
                  {
                     _loc2_ = Number(_loc10_.minWidth);
                  }
                  break;
               case null:
                  if(this._explicitSkinMinWidth > _loc2_)
                  {
                     _loc2_ = Number(this._explicitSkinMinWidth);
                     break;
                  }
                  break;
               case null:
         ...
         if(_loc11_)
         {
            ...
            if(this._layoutOrder === "labelAccessoryIcon")
            {
               _loc7_ = Number(this.addAccessoryHeight(_loc7_));
               _loc7_ = Number(this.addIconHeight(_loc7_));
            }
            else
            {
               _loc7_ = Number(this.addIconHeight(_loc7_));
            ...
            switch(_loc10_)
            {
               default:
                  ...
                  {
                     _loc7_ = Number(_loc10_.minHeight);
                  }
                  break;
               case null:
                  if(this._explicitSkinMinHeight > _loc7_)
                  {
                     _loc7_ = Number(this._explicitSkinMinHeight);
                     break;
                  }
                  break;
               case null:
      ...
      protected function refreshIconSource(param1:Object) : void
      {
         ...
         this.iconLoader.source#2 = param1;
      }
      ...
      protected function refreshAccessorySource(param1:Object) : void
      {
         ...
         this.accessoryLoader.source#2 = param1;
      }
      ...
      protected function refreshSkinSource(param1:Object) : void
      {
         ...
         this.skinLoader.source#2 = param1;
      }
      ...
      override protected function refreshLabelTextRendererDimensions(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            if(_loc3_ !== _loc3_)
            {
               _loc3_ = Number(this._explicitMaxWidth);
            }
         }
         _loc3_ -= this._paddingLeft + this._paddingRight;
         ...
         if(param1)
         {
            _loc8_ = Number(this._explicitHeight);
            if(_loc8_ !== _loc8_)
            {
               _loc8_ = Number(this._explicitMaxHeight);
            }
         }
         _loc8_ -= this._paddingTop + this._paddingBottom;
         var _loc9_:Number;
         if((_loc9_ = this._gap) == Infinity)
         {
            _loc9_ = this._minGap;
         }
         ...
         {
            _loc3_ = Number(this._explicitLabelMaxWidth);
         }
         if(_loc8_ > this._explicitLabelMaxHeight)
         {
            _loc8_ = Number(this._explicitLabelMaxHeight);
         }
      ...
      protected function accessory_touchHandler(param1:TouchEvent) : void
      {
         ...
         else
         {
            ...
            this.accessoryTouchPointID = _loc2_.id#2;
            this.refreshSelectionEvents();
         }
      }
