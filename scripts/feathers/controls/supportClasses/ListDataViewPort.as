package feathers.controls.supportClasses
{
   ...
   public class ListDataViewPort extends FeathersControl implements IViewPort
   {
      ...
      private function findUnrenderedData() : void
      {
         ...
         var _loc5_:int = 0;
         var _loc14_:int = !!this._dataProvider ? this._dataProvider.length : 0;
         var _loc20_:Boolean;
         var _loc15_:IVirtualLayout;
         if(_loc20_ = (_loc15_ = this._layout as IVirtualLayout) && _loc15_.useVirtualLayout)
         {
            _loc13_ = Pool.getPoint();
            _loc15_.measureViewPort(_loc14_,this._viewPortBounds,_loc13_);
            _loc15_.getVisibleIndicesAtScrollPosition(this._horizontalScrollPosition,this._verticalScrollPosition,_loc13_.x,_loc13_.y,_loc14_,HELPER_VECTOR);
            Pool.putPoint(_loc13_);
         }
         var _loc6_:int = !!_loc20_ ? HELPER_VECTOR.length : _loc14_;
         if(_loc20_ && this._typicalItemIsInDataProvider && this._typicalItemRenderer && HELPER_VECTOR.indexOf(this._typicalItemRenderer.index) >= 0)
         {
         ...
         var _loc2_:Boolean = this._layout is ITrimmedVirtualLayout && _loc20_ && (!(this._layout is IVariableVirtualLayout) || !IVariableVirtualLayout(this._layout).hasVariableItemDimensions) && _loc6_ > 0;
         if(_loc2_)
         {
            _loc18_ = _loc21_ = int(HELPER_VECTOR[0]);
            _loc7_ = 1;
            while(_loc7_ < _loc6_)
            {
               if((_loc8_ = HELPER_VECTOR[_loc7_]) < _loc21_)
               {
                  _loc21_ = _loc8_;
               }
               if(_loc8_ > _loc18_)
            ...
            if((_loc11_ = _loc21_ - 1) < 0)
            {
               _loc11_ = 0;
            }
            _loc16_ = _loc14_ - 1 - _loc18_;
            (_loc17_ = ITrimmedVirtualLayout(this._layout)).beforeVirtualizedItemCount = _loc11_;
            _loc17_.afterVirtualizedItemCount = _loc16_;
            this._layoutItems.length = _loc14_ - _loc11_ - _loc16_;
            this._layoutIndexOffset = -_loc11_;
         }
         else
         {
            this._layoutIndexOffset = 0;
            this._layoutItems.length = _loc14_;
         }
         var _loc4_:int = this._unrenderedData.length;
         _loc7_ = 0;
         while(_loc7_ < _loc6_)
         {
            if(!((_loc8_ = !!_loc20_ ? HELPER_VECTOR[_loc7_] : int(_loc7_)) < 0 || _loc8_ >= _loc14_))
            {
               _loc3_ = this._dataProvider.getItemAt(_loc8_);
               _loc1_ = IListItemRenderer(this._rendererMap[_loc3_]);
               if(this._factoryIDFunction !== null && _loc1_ !== null)
               {
                  if((_loc12_ = this.getFactoryID(_loc1_.data,_loc8_)) !== _loc1_.factoryID)
                  {
                     _loc1_ = null;
                     delete this._rendererMap[_loc3_];
                  }
               }
               if(_loc1_ !== null)
               {
                  ...
                  if(this._typicalItemRenderer !== _loc1_)
                  {
                     ...
                     _loc19_ = _loc10_.inactiveItemRenderers;
                     _loc9_[_loc9_.length] = _loc1_;
                     if((_loc5_ = _loc19_.indexOf(_loc1_)) < 0)
                     {
         ...
         if(this._typicalItemRenderer)
         {
            if(_loc20_ && this._typicalItemIsInDataProvider)
            {
      ...
      private function freeInactiveRenderers(param1:ItemRendererFactoryStorage, param2:int) : void
      {
         ...
         var _loc6_:int = (_loc7_ = param1.activeItemRenderers).length;
         var _loc9_:int = _loc5_.length;
         var _loc4_:*;
         if((_loc4_ = int(param2 - _loc6_)) > _loc9_)
         {
            _loc4_ = _loc9_;
         }
         _loc8_ = 0;
      ...
      private function dataProvider_updateItemHandler(param1:Event, param2:int) : void
      {
         ...
         if((_loc4_ = IListItemRenderer(this._rendererMap[_loc3_])) === null)
         {
            return;
         }
         _loc4_.data = null;
      ...
      private function renderer_changeHandler(param1:Event) : void
      {
         ...
         {
            this._selectedIndices.data#2 = new <int>[_loc5_];
         }
         else
         {
