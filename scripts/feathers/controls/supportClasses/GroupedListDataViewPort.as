package feathers.controls.supportClasses
{
   ...
   public class GroupedListDataViewPort extends FeathersControl implements IViewPort
   {
      ...
      public function get horizontalScrollStep() : Number
      {
         ...
         var _loc1_:Number = this._typicalItemRenderer.width;
         var _loc2_:Number = this._typicalItemRenderer.height;
         if(_loc1_ < _loc2_)
         {
            return _loc1_;
         }
      ...
      private function validateRenderers() : void
      {
         var _loc2_:int = 0;
         var _loc1_:* = null;
         var _loc3_:int = this._layoutItems.length;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
      ...
      private function findUnrenderedData() : void
      {
         ...
         var _loc3_:* = null;
         var _loc5_:int = 0;
         var _loc12_:int = !!this._dataProvider ? this._dataProvider.getLength() : 0;
         var _loc13_:int = 0;
         var _loc20_:int = 0;
         var _loc17_:int = 0;
         var _loc2_:int = 0;
         ...
         {
            _loc22_ = this._dataProvider.getItemAt(_loc4_);
            if(this._owner.groupToHeaderData(_loc22_) !== null)
            {
               this._headerIndices[_loc20_] = _loc13_;
               _loc13_++;
               _loc20_++;
            }
            _loc14_ = this._dataProvider.getLength(_loc4_);
            _loc13_ += _loc14_;
            _loc7_ += _loc14_;
            if(_loc14_ == 0)
            {
            ...
            if(this._owner.groupToFooterData(_loc22_) !== null)
            {
               this._footerIndices[_loc17_] = _loc13_;
               _loc13_++;
               _loc17_++;
            }
            _loc4_++;
         ...
         var _loc19_:Boolean;
         var _loc11_:IVirtualLayout;
         if(_loc19_ = (_loc11_ = this._layout as IVirtualLayout) && _loc11_.useVirtualLayout)
         {
            _loc10_ = Pool.getPoint();
            _loc11_.measureViewPort(_loc13_,this._viewPortBounds,_loc10_);
            _loc15_ = _loc10_.x;
            _loc21_ = _loc10_.y;
            Pool.putPoint(_loc10_);
            _loc11_.getVisibleIndicesAtScrollPosition(this._horizontalScrollPosition,this._verticalScrollPosition,_loc15_,_loc21_,_loc13_,HELPER_VECTOR);
            _loc7_ /= _loc12_;
            if(this._typicalItemRenderer)
            {
               _loc8_ = this._typicalItemRenderer.height;
               if(this._typicalItemRenderer.width < _loc8_)
               {
                  _loc8_ = this._typicalItemRenderer.width;
               }
               _loc16_ = _loc15_;
               if(_loc21_ > _loc15_)
               {
               ...
               this._minimumFirstAndLastItemCount = this._minimumSingleItemCount = this._minimumHeaderCount = this._minimumFooterCount = Math.ceil(_loc16_ / (_loc8_ * _loc7_));
               this._minimumHeaderCount = Math.min(this._minimumHeaderCount,_loc20_);
               this._minimumFooterCount = Math.min(this._minimumFooterCount,_loc17_);
               this._minimumSingleItemCount = Math.min(this._minimumSingleItemCount,_loc2_);
               this._minimumItemCount = Math.ceil(_loc16_ / _loc8_) + 1;
            }
            else
            {
         ...
         {
            _loc22_ = this._dataProvider.getItemAt(_loc4_);
            if((_loc18_ = this._owner.groupToHeaderData(_loc22_)) !== null)
            {
               if(_loc19_ && HELPER_VECTOR.indexOf(_loc9_) < 0)
               {
                  this._layoutItems[_loc9_] = null;
               }
               else
               {
                  this.findRendererForHeader(_loc18_,_loc4_,_loc9_);
               }
               _loc9_++;
            }
            _loc14_ = this._dataProvider.getLength(_loc4_);
            ...
            _loc3_ = this._owner.groupToFooterData(_loc22_);
            if(_loc3_ !== null)
            {
               if(_loc19_ && HELPER_VECTOR.indexOf(_loc9_) < 0)
               {
         ...
         if(this._typicalItemRenderer)
         {
            if(_loc19_ && this._typicalItemIsInDataProvider)
            {
      ...
      private function findRendererForItem(param1:Object, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc11_:int = 0;
         var _loc5_:IGroupedListItemRenderer = IGroupedListItemRenderer(this._itemRendererMap[param1]);
         if(this._factoryIDFunction !== null && _loc5_ !== null)
         {
            if((_loc10_ = this.getFactoryID(_loc5_.data,param2,param3)) !== _loc5_.factoryID)
            {
               _loc5_ = null;
         ...
         {
            _loc11_ = this._unrenderedItems.length;
      ...
      private function findRendererForHeader(param1:Object, param2:int, param3:int) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:IGroupedListHeaderRenderer = IGroupedListHeaderRenderer(this._headerRendererMap[param1]);
         if(this._headerFactoryIDFunction !== null && _loc10_ !== null)
         {
            if((_loc8_ = this.getHeaderFactoryID(_loc10_.data,param2)) !== _loc10_.factoryID)
            {
               _loc10_ = null;
         ...
         if(_loc10_ !== null)
         {
            ...
            _loc6_ = (_loc5_ = this.headerFactoryIDToStorage(_loc10_.factoryID)).activeHeaderRenderers;
            _loc7_ = _loc5_.inactiveHeaderRenderers;
            _loc6_[_loc6_.length] = _loc10_;
            if((_loc4_ = _loc7_.indexOf(_loc10_)) < 0)
            {
            ...
            _loc7_.removeAt(_loc4_);
            _loc10_.visible = true;
            this._layoutItems[param3] = DisplayObject(_loc10_);
         }
         else
         {
            _loc9_ = this._unrenderedHeaders.length;
            this._unrenderedHeaders[_loc9_] = param2;
            _loc9_++;
            this._unrenderedHeaders[_loc9_] = param3;
         }
      }
      ...
      private function findRendererForFooter(param1:Object, param2:int, param3:int) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc10_:int = 0;
         var _loc7_:IGroupedListFooterRenderer = IGroupedListFooterRenderer(this._footerRendererMap[param1]);
         if(this._footerFactoryIDFunction !== null && _loc7_ !== null)
         {
            if((_loc9_ = this.getFooterFactoryID(_loc7_.data,param2)) !== _loc7_.factoryID)
            {
               _loc7_ = null;
         ...
         if(_loc7_ !== null)
         {
            ...
            _loc7_.layoutIndex = param3;
            if(this._updateForDataReset)
            {
               _loc7_.data = null;
               _loc7_.data = param1;
            }
            _loc5_ = (_loc8_ = this.footerFactoryIDToStorage(_loc7_.factoryID)).activeFooterRenderers;
            _loc4_ = _loc8_.inactiveFooterRenderers;
            _loc5_[_loc5_.length] = _loc7_;
            if((_loc6_ = _loc4_.indexOf(_loc7_)) < 0)
            {
            ...
            _loc4_.removeAt(_loc6_);
            _loc7_.visible = true;
            this._layoutItems[param3] = DisplayObject(_loc7_);
         }
         else
         {
            _loc10_ = this._unrenderedFooters.length;
      ...
      private function renderUnrenderedData() : void
      {
         ...
         var _loc9_:* = null;
         var _loc7_:* = null;
         var _loc1_:int = this._unrenderedItems.length;
         _loc6_ = 0;
         while(_loc6_ < _loc1_)
         {
         ...
         _loc1_ = this._unrenderedHeaders.length;
         _loc6_ = 0;
         while(_loc6_ < _loc1_)
         {
         ...
         _loc1_ = this._unrenderedFooters.length;
         _loc6_ = 0;
         while(_loc6_ < _loc1_)
         {
      ...
      private function recoverInactiveItemRenderers(param1:ItemRendererFactoryStorage) : void
      {
         ...
         var _loc2_:int = (_loc4_ = param1.inactiveItemRenderers).length;
         _loc5_ = 0;
         while(_loc5_ < _loc2_)
         {
      ...
      private function recoverInactiveHeaderRenderers(param1:HeaderRendererFactoryStorage) : void
      {
         ...
         var _loc2_:int = (_loc4_ = param1.inactiveHeaderRenderers).length;
         _loc3_ = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      private function freeInactiveItemRenderers(param1:ItemRendererFactoryStorage, param2:int) : void
      {
         ...
         var _loc7_:int = (_loc8_ = param1.activeItemRenderers).length;
         var _loc5_:int;
      ...
      private function freeInactiveHeaderRenderers(param1:HeaderRendererFactoryStorage, param2:int) : void
      {
         ...
         var _loc5_:int = (_loc6_ = param1.activeHeaderRenderers).length;
      ...
      private function freeInactiveFooterRenderers(param1:FooterRendererFactoryStorage, param2:int) : void
      {
         ...
         var _loc6_:int = (_loc4_ = param1.activeFooterRenderers).length;
         var _loc5_:int;
      ...
      private function createFooterRenderer(param1:Object, param2:int, param3:int, param4:Boolean = false) : IGroupedListFooterRenderer
      {
         var _loc9_:* = null;
         var _loc10_:* = null;
         var _loc7_:String = this.getFooterFactoryID(param1,param2);
      ...
      private function dataProvider_addItemHandler(param1:Event, param2:Array) : void
      {
         ...
         else
         {
            ...
            if((_loc9_ = this._dataProvider.getLength(_loc7_)) > 0)
            {
               if((_loc10_ = _loc8_) < 0)
               {
                  _loc10_ = int(this.locationToDisplayIndex(_loc7_,0));
               }
               _loc9_ += _loc10_;
               _loc6_ = _loc10_;
               while(_loc6_ < _loc9_)
      ...
      private function dataProvider_updateItemHandler(param1:Event, param2:Array) : void
      {
         ...
         else
         {
            ...
            this.invalidate("data");
            if((_loc4_ = this._layout as IVariableVirtualLayout) === null || !_loc4_.hasVariableItemDimensions)
            {
               return;
            }
...
class ItemRendererFactoryStorage
{
   ...
   function ItemRendererFactoryStorage()
   {
...
class HeaderRendererFactoryStorage
{
   ...
   function HeaderRendererFactoryStorage()
   {
...
class FooterRendererFactoryStorage
{
   ...
   function FooterRendererFactoryStorage()
   {
