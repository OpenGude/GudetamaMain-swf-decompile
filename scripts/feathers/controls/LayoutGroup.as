package feathers.controls
{
   ...
   public class LayoutGroup extends FeathersControl
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.currentBackgroundSkin.setParent(null);
         }
      ...
      protected function refreshBackgroundSkin() : void
      {
         ...
         switch(_loc1_)
         {
            default:
               ...
               this.currentBackgroundSkin.setParent(this);
               break;
      ...
      protected function refreshViewPortBounds() : void
      {
         ...
         if(_loc1_ && this._autoSizeMode === "stage" && this.stage !== null)
         {
         ...
         if(_loc3_ && this._autoSizeMode === "stage" && this.stage !== null)
         {
         ...
         if(this.currentBackgroundSkin !== null)
         {
            ...
            {
               _loc4_ = Number(this.currentBackgroundSkin.width);
            }
      ...
      protected function handleManualLayout() : void
      {
         ...
         this._ignoreChildChanges = true;
         var _loc12_:int = this.items.length;
         _loc7_ = 0;
         while(_loc7_ < _loc12_)
         {
            ...
            if(!(_loc1_ is ILayoutDisplayObject && !ILayoutDisplayObject(_loc1_).includeInLayout))
            {
               ...
               _loc9_ = _loc1_.x - _loc1_.pivotX + _loc1_.width;
               _loc2_ = _loc1_.y - _loc1_.pivotY + _loc1_.height;
