package feathers.controls
{
   ...
   public class ToggleButton extends Button implements IGroupedToggle
   {
      ...
      public function set isSelected(param1:Boolean) : void
      {
         ...
         this.dispatchEventWith("custom");
      }
      
      public function set isSelectedWithOutCustomEvent(param1:Boolean) : void
      {
         if(this._isSelected === param1)
         {
            return;
      ...
      public function set selectedFontStyles(param1:TextFormat) : void
      {
         ...
         this._fontStylesSet.selectedFormat = param1;
      }
      ...
      override protected function getCurrentLabelProperties() : Object
      {
         ...
         {
            _loc1_ = this._stateToLabelProperties[this.currentState];
            if(_loc1_ !== null)
            {
               return _loc1_;
            }
