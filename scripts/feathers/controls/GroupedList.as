   ...
   public class GroupedList extends Scroller implements IFocusContainer
   {
      ...
      override protected function handlePendingScroll() : void
      {
         ...
         if(this.pendingGroupIndex >= 0)
         {
            ...
            if(_loc1_ is Object)
            {
               ...
               this.dataViewPort.getScrollPositionForIndex(this.pendingGroupIndex,this.pendingItemIndex,_loc3_);
               this.pendingGroupIndex = -1;
               this.pendingItemIndex = -1;
               _loc2_ = _loc3_.x;
               _loc4_ = _loc3_.y;
      ...
      override protected function stage_keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.dataViewPort.getNearestScrollPositionForIndex(this._selectedGroupIndex,this.selectedItemIndex,_loc6_);
            this.scrollToPosition(_loc6_.x,_loc6_.y,this._keyScrollDuration);
