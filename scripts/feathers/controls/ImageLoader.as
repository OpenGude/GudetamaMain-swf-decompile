package feathers.controls
{
   ...
   public class ImageLoader extends FeathersControl
   {
      ...
      public function get source#2() : Object
      {
         return this._source;
      }
      
      public function set source#2(param1:Object) : void
      {
         var _loc2_:* = null;
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(!_loc5_ && !_loc9_ && !_loc6_ && !_loc10_)
         {
            return false;
         }
         var _loc3_:* = 1;
         var _loc1_:* = 1;
         if(this._scaleContent && this._maintainAspectRatio && this._scaleMode !== "none" && this._scale9Grid === null)
         {
            if(!_loc9_)
            {
               _loc3_ = Number(this._explicitHeight / (this._currentTextureHeight * this._textureScale));
            }
            else if(this._explicitMaxHeight < this._currentTextureHeight)
            {
               _loc3_ = Number(this._explicitMaxHeight / (this._currentTextureHeight * this._textureScale));
            }
            else if(this._explicitMinHeight > this._currentTextureHeight)
            {
               _loc3_ = Number(this._explicitMinHeight / (this._currentTextureHeight * this._textureScale));
            }
            if(!_loc5_)
            {
               _loc1_ = Number(this._explicitWidth / (this._currentTextureWidth * this._textureScale));
            }
            else if(this._explicitMaxWidth < this._currentTextureWidth)
            {
               _loc1_ = Number(this._explicitMaxWidth / (this._currentTextureWidth * this._textureScale));
            }
            else if(this._explicitMinWidth > this._currentTextureWidth)
            {
               _loc1_ = Number(this._explicitMinWidth / (this._currentTextureWidth * this._textureScale));
            }
         }
         ...
         if(_loc5_)
         {
            ...
            {
               _loc4_ = Number(this._currentTextureWidth * this._textureScale * _loc3_);
            }
            else
            {
               _loc4_ = 0;
         ...
         if(_loc9_)
         {
            ...
            {
               _loc7_ = Number(this._currentTextureHeight * this._textureScale * _loc1_);
            }
            else
            {
               _loc7_ = 0;
         ...
         if(_loc6_)
         {
            if(this._currentTextureWidth === this._currentTextureWidth)
            {
               _loc2_ = Number(this._currentTextureWidth * this._textureScale * _loc3_);
            }
            else
            {
               _loc2_ = 0;
         ...
         if(_loc10_)
         {
            if(this._currentTextureHeight === this._currentTextureHeight)
            {
               _loc8_ = Number(this._currentTextureHeight * this._textureScale * _loc1_);
            }
            else
            {
               _loc8_ = 0;
         ...
         return this.saveMeasurements(_loc4_,_loc7_,_loc2_,_loc8_);
      }
      ...
      protected function cleanupLoaders(param1:Boolean) : void
      {
         ...
         if(this.loader)
         {
            ...
            if(param1)
            {
               this.loader.contentLoaderInfo.addEventListener("complete",orphanedLoader_completeHandler);
            }
            this.loader = null;
         }
      }
      ...
      {
         if(this.stage === null || starling.core.Starling.sCurrent.stage === this.stage)
         {
            return;
         }
      ...
      protected function replaceBitmapDataTexture(param1:BitmapData) : void
      {
         ...
         var starling:Starling = this.stage !== null ? this.stage.starling : (_loc2_ = Starling, starling.core.Starling.sCurrent);
         ...
         var _loc4_:* = SystemUtil;
         starling.utils.SystemUtil.initialize();
         if(!starling.utils.SystemUtil.sDesktop && !starling.utils.SystemUtil.sApplicationActive)
         {
      ...
      protected function replaceRawTextureData(param1:ByteArray) : void
      {
         ...
         if(!_loc2_.contextValid)
         {
            trace("ImageLoader: Context lost while processing loaded image, retrying...");
            setTimeout(replaceRawTextureData,1,param1);
            return;
         }
         var _loc5_:* = SystemUtil;
         starling.utils.SystemUtil.initialize();
         if(!starling.utils.SystemUtil.sDesktop && !starling.utils.SystemUtil.sApplicationActive)
         {
         ...
         else
         {
            ...
            if(this._textureCache)
            {
               _loc3_ = this.sourceToTextureCacheKey(this._source);
               if(_loc3_ !== null)
               {
                  this._textureCache.addTexture(_loc3_,this._texture,true);
               }
            }
         }
         param1.clear();
      ...
      protected function loader_completeHandler(param1:flash.events.Event) : void
      {
         ...
         var _loc4_:Boolean;
         if(!(_loc4_ = this._texture !== null && (!this._asyncTextureUpload || this._texture.root.uploadBitmapData.length === 1) && this._texture.nativeWidth === _loc2_.width && this._texture.nativeHeight === _loc2_.height && this._texture.scale === this._scaleFactor && this._texture.format === this._textureFormat))
         {
            this.cleanupTexture();
         }
      ...
      protected function orphanedLoader_completeHandler(param1:flash.events.Event) : void
      {
         ...
         (_loc4_ = LoaderInfo(param1.currentTarget)).removeEventListener("complete",orphanedLoader_completeHandler);
         var _loc2_:Loader = _loc4_.loader;
      ...
      {
         var _loc2_:ByteArray = ByteArray(this.urlLoader.data#2);
         this.cleanupLoaders(false);
