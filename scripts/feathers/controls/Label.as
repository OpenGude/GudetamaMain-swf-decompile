package feathers.controls
{
   ...
   public class Label extends FeathersControl implements ITextBaselineControl, IToolTip
   {
      ...
      protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(!_loc3_ && !_loc7_ && !_loc4_ && !_loc12_)
         {
            return false;
         }
         ...
         this.textRenderer.measureText(_loc10_);
         ...
         if(_loc4_)
         {
            ...
            if(_loc9_ !== null)
            {
               _loc8_ = Number(_loc9_.minWidth);
            }
            else if(this.currentBackgroundSkin !== null)
            {
               _loc8_ = Number(this._explicitBackgroundMinWidth);
            }
            if(_loc8_ > _loc1_)
            {
               _loc1_ = _loc8_;
         ...
         if(_loc12_)
         {
            ...
            if(_loc9_ !== null)
            {
               _loc11_ = Number(_loc9_.minHeight);
            }
            else if(this.currentBackgroundSkin !== null)
            {
