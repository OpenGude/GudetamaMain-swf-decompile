package feathers.controls
{
   ...
   public class Button extends BasicButton implements IFocusDisplayObject, ITextBaselineControl
   {
      ...
      public function set scaleWhenHovering(param1:Number) : void
      {
         ...
         if(this._scaleWhenHovering === param1)
         {
            return;
         }
      ...
      override public function render(param1:Painter) : void
      {
         ...
         {
            _loc2_ = Number(this._scaleWhenDown);
         }
         else if(this._currentState === "hover")
         {
            _loc2_ = Number(this._scaleWhenHovering);
         }
         if(_loc2_ !== 1)
         {
      ...
      {
         var _loc4_:String = "setIconForState--" + param1;
      ...
      override protected function autoSizeIfNeeded() : Boolean
      {
         ...
         if(_loc8_)
         {
            ...
            switch(_loc1_)
            {
               default:
                  ...
                  {
                     if((_loc6_ = IFeathersControl(this.currentIcon).minWidth) > _loc7_)
                     {
                        _loc7_ = _loc6_;
                     }
                  }
                  ...
                  {
                     _loc7_ = Number(this.currentIcon.width);
                  }
                  break;
               case null:
                  if(this.currentIcon is IFeathersControl)
            ...
            switch(_loc12_)
            {
               default:
                  ...
                  {
                     _loc7_ = Number(_loc12_.minWidth);
                  }
                  break;
               case null:
                  if(this._explicitSkinMinWidth > _loc7_)
                  {
                     _loc7_ = Number(this._explicitSkinMinWidth);
                     break;
                  }
                  break;
               case null:
         ...
         if(_loc13_)
         {
            ...
            switch(_loc1_)
            {
               default:
                  ...
                  {
                     _loc2_ = IFeathersControl(this.currentIcon).minHeight;
                     if(_loc2_ > _loc9_)
                     {
                        _loc9_ = _loc2_;
                     }
                  ...
                  {
                     _loc9_ = Number(this.currentIcon.height);
                  }
                  break;
               case null:
                  if(this.currentIcon is IFeathersControl)
            ...
            switch(_loc12_)
            {
               default:
                  ...
                  {
                     _loc9_ = Number(_loc12_.minHeight);
                  }
                  break;
               case null:
                  if(this._explicitSkinMinHeight > _loc9_)
                  {
                     _loc9_ = Number(this._explicitSkinMinHeight);
                     break;
                  }
                  break;
               case null:
         ...
         if(_loc4_)
         {
            ...
            {
               _loc3_ = Number(this.currentSkin.width);
            }
         }
         ...
         if(_loc10_)
         {
            ...
            switch(_loc1_)
            {
               default:
                  ...
                  {
                     _loc5_ = Number(this.currentIcon.height);
                  }
                  break;
               case null:
                  _loc5_ = Number(this.currentIcon.height);
      ...
      protected function refreshLabelTextRendererDimensions(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _loc2_ = Number(this._explicitWidth);
            if(_loc2_ !== _loc2_)
            {
               _loc2_ = Number(this._explicitMaxWidth);
            }
            _loc4_ = Number(this._explicitHeight);
            if(_loc4_ !== _loc4_)
            {
               _loc4_ = Number(this._explicitMaxHeight);
            }
         }
         ...
         if(_loc2_ > this._explicitLabelMaxWidth)
         {
            _loc2_ = Number(this._explicitLabelMaxWidth);
         }
         if(_loc4_ > this._explicitLabelMaxHeight)
         {
            _loc4_ = Number(this._explicitLabelMaxHeight);
         }
         ...
         this.labelTextRenderer.maxWidth = _loc2_;
         this.labelTextRenderer.maxHeight = _loc4_;
         this.labelTextRenderer.validate();
         if(!param1)
         {
            _loc2_ = Number(this.labelTextRenderer.width);
            _loc4_ = Number(this.labelTextRenderer.height);
            this.labelTextRenderer.width = _loc2_;
            this.labelTextRenderer.height = _loc4_;
            this.labelTextRenderer.minWidth = _loc2_;
