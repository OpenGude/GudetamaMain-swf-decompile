package feathers.controls.popups
{
   ...
   public class VerticalCenteredPopUpContentManager extends EventDispatcher implements IPopUpContentManager
   {
      ...
      public function open(param1:DisplayObject, param2:DisplayObject) : void
      {
         ...
         this.layout();
         var _loc5_:* = Starling;
         var _loc3_:Stage = starling.core.Starling.sCurrent.stage;
      ...
      public function close() : void
      {
         ...
         var _loc4_:* = Starling;
         starling.core.Starling.sCurrent.nativeStage.removeEventListener("keyDown",nativeStage_keyDownHandler);
      ...
      protected function layout() : void
      {
         var _loc3_:* = null;
         var _loc6_:* = Starling;
         var _loc2_:Stage = starling.core.Starling.sCurrent.stage;
         var _loc5_:Number;
      ...
      protected function stage_touchHandler(param1:TouchEvent) : void
      {
         ...
         if(this.touchPointID >= 0)
         {
            ...
            _loc4_.getLocation(_loc2_,_loc6_);
            _loc5_ = _loc2_.hitTest(_loc6_);
