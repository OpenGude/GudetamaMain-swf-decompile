package feathers.controls
{
   ...
   public class SpinnerList extends List
   {
      ...
      override protected function refreshMinAndMaxScrollPositions() : void
      {
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:Number = this.actualPageWidth;
         ...
         if(this._maxVerticalScrollPosition !== this._minVerticalScrollPosition)
         {
            ...
            {
               _loc1_ = this.calculateNearestPageIndexForItem(this._selectedIndex,this._verticalPageIndex,this._maxVerticalPageIndex);
               this._verticalScrollPosition = this.actualPageHeight * _loc1_;
            }
         }
         else if(this._maxHorizontalScrollPosition !== this._minHorizontalScrollPosition)
         {
            ...
            if(!this.isScrolling && this.pendingItemIndex === -1 && this.actualPageWidth !== _loc4_)
            {
               _loc3_ = this.calculateNearestPageIndexForItem(this._selectedIndex,this._horizontalPageIndex,this._maxHorizontalPageIndex);
               this._horizontalScrollPosition = this.actualPageWidth * _loc3_;
            }
         }
      }
