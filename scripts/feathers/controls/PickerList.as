   ...
   public class PickerList extends FeathersControl implements IFocusDisplayObject, ITextBaselineControl
   {
      ...
      public function set dataProvider(param1:ListCollection) : void
      {
         ...
         if(this._dataProvider)
         {
            ...
            this._dataProvider.removeEventListener("removeAll",dataProvider_multipleEventHandler);
         ...
         if(this._dataProvider)
         {
            ...
            this._dataProvider.addEventListener("removeAll",dataProvider_multipleEventHandler);
      ...
      public function set popUpContentManager(param1:IPopUpContentManager) : void
      {
         ...
         if(this._popUpContentManager is EventDispatcher)
         {
            ...
            _loc3_.removeEventListener("open",popUpContentManager_openHandler);
            _loc3_.removeEventListener("close",popUpContentManager_closeHandler);
         }
         this._popUpContentManager = param1;
         if(this._popUpContentManager is EventDispatcher)
         {
            _loc3_ = EventDispatcher(this._popUpContentManager);
            _loc3_.addEventListener("open",popUpContentManager_openHandler);
            _loc3_.addEventListener("close",popUpContentManager_closeHandler);
         }
      ...
      override protected function initialize() : void
      {
         ...
         {
            var _loc3_:*;
            _loc1_ = this.stage !== null ? this.stage.starling : (_loc3_ = Starling, starling.core.Starling.sCurrent);
            var _loc4_:* = SystemUtil;
            starling.utils.SystemUtil.initialize();
            if(starling.utils.SystemUtil.sDesktop)
            {
      ...
      protected function button_touchHandler(param1:TouchEvent) : void
      {
         ...
         else
         {
            ...
            this._buttonTouchPointID = _loc2_.id#2;
