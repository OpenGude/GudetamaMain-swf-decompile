package feathers.utils.touch
{
   ...
   public class LongPress
   {
      ...
      protected function target_touchHandler(param1:TouchEvent) : void
      {
         ...
         {
            _loc3_ = param1.getTouch(this._target,null,this._touchPointID);
            if(!_loc3_)
            {
               return;
            }
            ...
            {
               this._touchLastGlobalPosition.x = _loc3_.globalX;
               this._touchLastGlobalPosition.y = _loc3_.globalY;
            }
         ...
         _loc3_ = param1.getTouch(DisplayObject(this._target),"began");
         if(!_loc3_)
         {
            return;
         }
         if(this._customHitTest !== null)
         {
            ...
            _loc3_.getLocation(DisplayObject(this._target),_loc4_);
            _loc2_ = this._customHitTest(_loc4_);
