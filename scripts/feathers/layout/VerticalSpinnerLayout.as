package feathers.layout
{
   ...
   public class VerticalSpinnerLayout extends EventDispatcher implements ISpinnerLayout, ITrimmedVirtualLayout
   {
      ...
      public function layout(param1:Vector.<DisplayObject>, param2:ViewPortBounds = null, param3:LayoutBoundsResult = null) : LayoutBoundsResult
      {
         ...
         var _loc34_:* = Number(!!this._useVirtualLayout ? _loc26_ : 0);
         var _loc8_:* = _loc31_;
         var _loc12_:Number = this._gap;
         var _loc27_:int;
         var _loc28_:* = _loc27_ = param1.length;
         if(this._useVirtualLayout)
         {
         ...
         var _loc21_:int = (_loc20_ = !!this._useVirtualLayout ? this._discoveredItemsCache : param1).length;
         ...
         if(_loc5_ !== _loc5_)
         {
            ...
            {
               _loc5_ = Number(this._requestedRowCount * (_loc23_ + _loc12_) - _loc12_);
            }
            else
            {
               _loc5_ = _loc4_;
         ...
         param3.contentX = 0;
         param3.contentWidth = this._horizontalAlign == "justify" ? _loc22_ : Number(_loc15_);
         if(_loc16_)
         {
      ...
      public function measureViewPort(param1:int, param2:ViewPortBounds = null, param3:Point = null) : Point
      {
         ...
         var _loc12_:* = 0;
         var _loc17_:* = _loc8_;
         _loc12_ = Number((_loc12_ += (_loc5_ + _loc14_) * param1) - _loc14_);
         if(_loc4_)
         {
            if((_loc9_ = Number(_loc17_ + this._paddingLeft + this._paddingRight)) < _loc6_)
            {
               _loc9_ = _loc6_;
            }
         ...
         if(_loc15_)
         {
            if(this._requestedRowCount > 0)
            {
               _loc7_ = Number((_loc5_ + _loc14_) * this._requestedRowCount - _loc14_);
            }
            else
            {
               _loc7_ = _loc12_;
