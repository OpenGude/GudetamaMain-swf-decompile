package feathers.skins
{
   ...
   public class ImageSkin extends Image implements IMeasureDisplayObject, IStateObserver
   {
      ...
      protected function updateColorFromContext() : void
      {
         ...
         {
            _loc1_ = uint(this._stateToColor[_loc2_] as uint);
         }
         ...
         {
            _loc1_ = uint(this._disabledColor);
         }
         if(_loc1_ === 4294967295 && this._selectedColor !== 4294967295 && this._stateContext is IToggle && IToggle(this._stateContext).isSelected)
         {
            _loc1_ = uint(this._selectedColor);
         }
         if(_loc1_ === 4294967295)
         {
            _loc1_ = uint(this._defaultColor);
         }
         if(_loc1_ !== 4294967295)
         {
            this.color = _loc1_;
