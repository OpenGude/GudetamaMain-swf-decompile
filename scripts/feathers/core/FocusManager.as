   ...
   public class FocusManager
   {
      ...
      public static function setEnabledForStage(param1:Stage, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            {
               (_loc4_ = _loc3_.pop()).isEnabled = false;
            }
      ...
      {
         var _loc2_:* = Starling;
         var _loc1_:IFocusManager = getFocusManagerForStage(starling.core.Starling.sCurrent.stage);
         if(_loc1_)
         {
            return _loc1_.focus;
         }
      ...
      {
         var _loc3_:* = Starling;
         var _loc2_:IFocusManager = getFocusManagerForStage(starling.core.Starling.sCurrent.stage);
         if(!_loc2_)
         {
      ...
      public static function pushFocusManager(param1:DisplayObjectContainer) : IFocusManager
      {
         ...
         (_loc4_ = FocusManager.focusManagerFactory(param1)).isEnabled = true;
         if(_loc2_.length > 0)
         {
            (_loc5_ = _loc2_[_loc2_.length - 1]).isEnabled = false;
         }
         _loc2_.push(_loc4_);
         return _loc4_;
      }
      ...
      public static function removeFocusManager(param1:IFocusManager) : void
      {
         ...
         var _loc4_:int;
         if((_loc4_ = _loc2_.indexOf(param1)) < 0)
         {
            return;
         }
