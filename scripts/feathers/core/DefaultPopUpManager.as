package feathers.core
{
   ...
   public class DefaultPopUpManager implements IPopUpManager
   {
      ...
      public function set root(param1:DisplayObjectContainer) : void
      {
         ...
         {
            _loc3_ = this._popUps[_loc6_];
            if(_loc4_ = DisplayObject(_popUpToOverlay[_loc3_]))
            {
      ...
      public function addPopUp(param1:DisplayObject, param2:Boolean = true, param3:Boolean = true, param4:Function = null) : DisplayObject
      {
         ...
         if(param2)
         {
            ...
            (_loc5_ = param4()).width = this._root.stage.stageWidth;
      ...
      public function removeAllPopUps(param1:Boolean = false) : void
      {
         var _loc5_:int = 0;
         var _loc2_:* = null;
         var _loc4_:Vector.<DisplayObject>;
         var _loc3_:int = (_loc4_ = this._popUps.slice()).length;
         _loc5_ = 0;
         while(_loc5_ < _loc3_)
         {
            _loc2_ = _loc4_[_loc5_];
            this.removePopUp(_loc2_,param1);
            _loc5_++;
         }
      }
      ...
      public function isTopLevelPopUp(param1:DisplayObject) : Boolean
      {
         ...
         var _loc3_:* = null;
         var _loc5_:int;
         _loc4_ = _loc5_ = this._popUps.length - 1;
         while(_loc4_ >= 0)
         {
      ...
      protected function popUp_removedFromStageHandler(param1:Event) : void
      {
         ...
         this._popUps.removeAt(_loc5_);
         var _loc4_:DisplayObject;
         if(_loc4_ = DisplayObject(this._popUpToOverlay[_loc2_]))
         {
         ...
         if((_loc5_ = this._centeredPopUps.indexOf(_loc2_)) >= 0)
         {
            if(_loc2_ is IFeathersControl)
            {
               _loc2_.removeEventListener("resize",popUp_resizeHandler);
            }
            this._centeredPopUps.removeAt(_loc5_);
         }
         if(_popUps.length == 0)
         {
