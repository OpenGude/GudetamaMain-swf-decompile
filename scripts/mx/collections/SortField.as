package mx.collections
{
   ...
   public class SortField extends EventDispatcher
   {
      ...
      {
         if(mx_internal::usingCustomCompareFunction || name#2 == null || _compareFunction == xmlCompare || _compareFunction == dateCompare)
         {
            return -1;
         }
         var _loc1_:* = 0;
      ...
      private function nullCompare(param1:Object, param2:Object) : int
      {
         ...
         message = resourceManager.getString("collections","noComparatorSortField",[name#2]);
