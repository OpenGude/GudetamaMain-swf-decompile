package mx.rpc.http
{
   ...
   public class HTTPService extends AbstractInvoker
   {
      ...
      public var method#2:String = "GET";
      ...
      public function HTTPService(param1:String = null, param2:String = null)
      {
         ...
         if(param2 == null)
         {
            if(URLUtil.isHttpsURL(LoaderConfig.url#2))
            {
      ...
      public function send(param1:Object = null) : AsyncToken
      {
         ...
         if(useProxy)
         {
            if(url#2 && url#2 != "")
            {
               _loc7_.url#2 = URLUtil.getFullURL(rootURL,url#2);
            }
         }
         else
         {
         ...
         _loc7_.method#2 = method#2.toUpperCase();
         if(contentType == CONTENT_TYPE_XML && _loc7_.method#2 == HTTPRequestMessage.GET_METHOD)
         {
            _loc7_.method#2 = HTTPRequestMessage.POST_METHOD;
         }
         _loc7_.body = _loc2_;
         _loc7_.httpHeaders = headers#2;
      ...
      override mx_internal function processResult(param1:IMessage, param2:AsyncToken) : Boolean
      {
         ...
         if(body is String)
         {
            if(resultFormat#2 == RESULT_FORMAT_XML || resultFormat#2 == RESULT_FORMAT_OBJECT || resultFormat#2 == RESULT_FORMAT_ARRAY)
            {
               tmp = new XMLDocument();
               ...
               if(resultFormat#2 == RESULT_FORMAT_OBJECT || resultFormat#2 == RESULT_FORMAT_ARRAY)
               {
                  if(xmlDecode != null)
                  {
                  ...
                  if(resultFormat#2 == RESULT_FORMAT_ARRAY)
                  {
            ...
            else if(resultFormat#2 == RESULT_FORMAT_E4X)
            {
               try
               {
            ...
            else if(resultFormat#2 == RESULT_FORMAT_FLASHVARS)
            {
