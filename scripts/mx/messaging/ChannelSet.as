package mx.messaging
{
   ...
   public class ChannelSet extends EventDispatcher
   {
      ...
      private function hunt() : Boolean
      {
         ...
         if(_channelFailoverURIs != null && _channelFailoverURIs[_currentChannel.id#2] != null)
         {
            _currentChannel.failoverURIs = _channelFailoverURIs[_currentChannel.id#2];
         }
         return true;
      }
      ...
      public function channelConnectHandler(param1:ChannelEvent) : void
      {
         ...
         while(_pendingSends.length > 0)
         {
            ...
            {
               _loc4_.headers#2[CommandMessage.NEEDS_CONFIG_HEADER] = true;
      ...
      private function faultPendingSends(param1:ChannelEvent) : void
      {
         ...
         while(_pendingSends.length > 0)
         {
            ...
            _loc4_.headers#2[ErrorMessage.RETRYABLE_HINT_HEADER] = true;
      ...
      mx_internal function set channelFailoverURIs(param1:Object) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(_channelFailoverURIs[_loc4_.id#2] != null)
            {
               _loc4_.failoverURIs = _channelFailoverURIs[_loc4_.id#2];
            }
            _loc3_++;
         }
      }
...
class AuthenticationAgent extends MessageAgent
{
   ...
   override public function acknowledge(param1:AcknowledgeMessage, param2:IMessage) : void
   {
      ...
      var _loc3_:Boolean = param1.headers#2[AcknowledgeMessage.ERROR_HINT_HEADER];
