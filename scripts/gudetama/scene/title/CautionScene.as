package gudetama.scene.title
{
   ...
   public class CautionScene extends BaseScene
   {
      ...
      override protected function setupProgress(param1:Function) : void
      {
         ...
         setupLayoutForTask(queue,"CautionLayout",function(param1:Object):void
         {
      ...
      private function checkInit() : void
      {
         ...
         Engine.lockTouchInput(CautionScene);
         ...
         var _loc2_:* = Starling;
         (!!starling.core.Starling.sCurrent ? starling.core.Starling.sCurrent._juggler : null).delayCall(goTitle,8);
      }
      ...
      {
         Engine.unlockTouchInput(CautionScene);
      }
